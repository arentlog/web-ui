...
using Infor.Sxe.Web.FrontEnd.Infrastructure.Swagger;
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Infor Distribution SXe");
                       ...
                       // Add default headers for each call, for QA Central.
                       c.OperationFilter(() => new AddRequiredHeaderParameter());

                       // Provide a caching provider to cache the document after it's first been produced.
