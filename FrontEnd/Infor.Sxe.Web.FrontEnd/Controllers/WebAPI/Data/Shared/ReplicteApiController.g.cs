...
{  
   ...
   using Sxe.Shared.Data.Models.Pdsreplicte;
   using Sxe.Shared.Data.Repositories;
    
   [RoutePrefix("api/shared/replicte")]
   public partial class ReplicteApiController : ApiControllerBase
   {
      private readonly ReplicteRepository repository;
    
      public ReplicteApiController(ReplicteRepository repository)
      {
      ...
      [HttpPost]
      [Route("listbyrowids")]      
      public IEnumerable<Replicte> GetListByRowIdList(List<string> rowids, string fldlist = "")
      {
         if (rowids == null || rowids.Count == 0)
         {
            return new List<Replicte>();
         }
      ...
      [HttpGet]
      [Route("getbypk")]
      public Replicte Get(string tablenm = "", string fldlist = "")
      {
