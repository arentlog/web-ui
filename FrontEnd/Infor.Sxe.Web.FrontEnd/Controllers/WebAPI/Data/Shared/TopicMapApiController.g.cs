...
{  
   ...
   using Sxe.Shared.Data.Models.PdstopicMap;
   using Sxe.Shared.Data.Repositories;
    
   [RoutePrefix("api/shared/topicmap")]
   public partial class TopicMapApiController : ApiControllerBase
   {
      private readonly TopicMapRepository repository;
    
      public TopicMapApiController(TopicMapRepository repository)
      {
