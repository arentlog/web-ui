...
{  
   ...
   using Sxe.TWL.Data.Models.Pdscarrier;
   using Sxe.TWL.Data.Repositories;
    
   [RoutePrefix("api/twl/carrier")]
   public partial class CarrierApiController : ApiControllerBase
   {
      ...
      [HttpPost]
      [Route("listbyrowids")]      
      public IEnumerable<Carrier> GetListByRowIdList(List<string> rowids, string fldlist = "")
      {
      ...
      [HttpGet]
      [Route("getbypk")]
      public Carrier Get(string coNum = "", string whNum = "", string carrierId = "", string fldlist = "")
      {
         return this.repository.Get(coNum, whNum, carrierId, 1, fldlist);
      }
        
      [HttpGet]
      [Route("existsbypk")]
      public bool Exists(string coNum = "", string whNum = "", string carrierId = "")
      {
         return (this.repository.Get(coNum, whNum, carrierId, 1, string.Empty) != null);
      }
      ...
      public IEnumerable<Carrier> GetListByTransdttmz(DateTime? transdttmz = null,  int batchsize = 0, string fldlist = "")
      {
