...
{  
   ...
   using Sxe.SL.Data.Models.Pdsslst;
   using Sxe.SL.Data.Repositories;
    
   [RoutePrefix("api/sl/slst")]
   public partial class SlstApiController : ApiControllerBase
   {
      private readonly SlstRepository repository;
      ...
      [HttpPost]
      [Route("listbyrowids")]      
      public IEnumerable<Slst> GetListByRowIdList(List<string> rowids, string fldlist = "")
      {
         if (rowids == null || rowids.Count == 0)
         {
            return new List<Slst>();
         }
      ...
      [HttpGet]
      [Route("")]
      public IEnumerable<Slst> GetListAllByCono(int batchsize = 0, string fldlist = "")
      {  
         return this.repository.GetListAllByCono(0, batchsize, fldlist);
      }
      [HttpGet]
      [Route("getbypk")]
      public Slst Get(string codeiden = "", string codeval = "", string fldlist = "")
      {
      ...
      [HttpGet]
      [Route("listbydesc")]
      public IEnumerable<Slst> GetListByDesc(string codeiden = "", string descrip = "",  int batchsize = 0, string fldlist = "")
      {
