 ...
 * Alias: lkupmdl
 */
app.controller('DrawerLookupModalCtrl', function ($scope, DataService, Utils) {
   var self = this;
   var lkup = $scope.lkup;
   ...
   self.search = function () {
      var crit = {
         whse: self.criteria ? self.criteria.whse : '',
         drawerid: self.criteria ? self.criteria.drawerid : ''
      };
