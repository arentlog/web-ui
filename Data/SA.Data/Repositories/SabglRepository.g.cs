...
namespace Infor.Sxe.SA.Data.Repositories
{
   ...
   public partial class SabglRepository : RepositoryBase
   {
      private SabglAdapter adapter;
  
      public SabglRepository(IProgressConnection connection)
      {
         this.adapter = new SabglAdapter(connection);
