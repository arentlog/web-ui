...
namespace Infor.Sxe.SA.Data.Repositories
{
   ...
   public partial class SasstRepository : RepositoryBase
   {
      private SasstAdapter adapter;
  
      public SasstRepository(IProgressConnection connection)
      {
         this.adapter = new SasstAdapter(connection);
      ...
      {
         return this.adapter.Get(zipcd, batchsize, fldList);
      }
