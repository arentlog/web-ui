...
namespace Infor.Sxe.SA.Data.Repositories
{
   ...
   public partial class SascRepository : RepositoryBase
   {
      private SascAdapter adapter;
  
      public SascRepository(IProgressConnection connection)
      {
         this.adapter = new SascAdapter(connection);
