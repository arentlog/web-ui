...
namespace Infor.Sxe.SA.Data.Repositories
{
   ...
   public partial class SasgmRepository : RepositoryBase
   {
      private SasgmAdapter adapter;
  
      public SasgmRepository(IProgressConnection connection)
      {
         this.adapter = new SasgmAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, recty, taxgroup, statecd, countycd, citycd, othercd, batchsize, fldList);
      }
      ...
      {
         return this.adapter.Lookup(sataxmasterlookupcriteria);
      }
