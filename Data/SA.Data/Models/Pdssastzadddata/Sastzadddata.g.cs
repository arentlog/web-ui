...
namespace Infor.Sxe.SA.Data.Models.Pdssastzadddata
{
   [ModelName("Infor.Sxe.SA.Data.Models.Pdssastzadddata.Sastzadddata")]
   public partial class Sastzadddata : ModelBase
   {
      ...
      public static Sastzadddata BuildSastzadddataFromRow(DataRow row)
      {
         Sastzadddata entity = new Sastzadddata();
      ...
      /// </summary>
      public static void UpdateRowFromSastzadddata(ref DataRow row, Sastzadddata entity)
      {
