...
namespace Infor.Sxe.SA.Data.Models.Pdssasosetupfuncsecavail
{
   [ModelName("Infor.Sxe.SA.Data.Models.Pdssasosetupfuncsecavail.Sasosetupfuncsecavail")]
   public partial class Sasosetupfuncsecavail : ModelBase
   {
      ...
      public static Sasosetupfuncsecavail BuildSasosetupfuncsecavailFromRow(DataRow row)
      {
         Sasosetupfuncsecavail entity = new Sasosetupfuncsecavail();
      ...
      /// </summary>
      public static void UpdateRowFromSasosetupfuncsecavail(ref DataRow row, Sasosetupfuncsecavail entity)
      {
