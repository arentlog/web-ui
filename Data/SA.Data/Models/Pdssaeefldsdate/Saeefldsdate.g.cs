...
namespace Infor.Sxe.SA.Data.Models.Pdssaeefldsdate
{
   [ModelName("Infor.Sxe.SA.Data.Models.Pdssaeefldsdate.Saeefldsdate")]
   public partial class Saeefldsdate : ModelBase
   {
      ...
      public static Saeefldsdate BuildSaeefldsdateFromRow(DataRow row)
      {
         Saeefldsdate entity = new Saeefldsdate();
         ...
         entity.datefield = row.Field<DateTime?>("datefield");
      ...
      /// </summary>
      public static void UpdateRowFromSaeefldsdate(ref DataRow row, Saeefldsdate entity)
      {
         ...
         row.SetField("datefield", entity.datefield);
