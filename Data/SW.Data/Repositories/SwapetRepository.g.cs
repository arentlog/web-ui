...
namespace Infor.Sxe.SW.Data.Repositories
{
   ...
   public partial class SwapetRepository : RepositoryBase
   {
      private SwapetAdapter adapter;
  
      public SwapetRepository(IProgressConnection connection)
      {
         this.adapter = new SwapetAdapter(connection);
