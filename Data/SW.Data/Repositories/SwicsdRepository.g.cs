...
namespace Infor.Sxe.SW.Data.Repositories
{
   ...
   public partial class SwicsdRepository : RepositoryBase
   {
      private SwicsdAdapter adapter;
  
      public SwicsdRepository(IProgressConnection connection)
      {
         this.adapter = new SwicsdAdapter(connection);
