...
namespace Infor.Sxe.SW.Data.Repositories
{
   ...
   public partial class SwsssRepository : RepositoryBase
   {
      private SwsssAdapter adapter;
  
      public SwsssRepository(IProgressConnection connection)
      {
         this.adapter = new SwsssAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, tech, wkstartdt, batchsize, fldList);
      }
