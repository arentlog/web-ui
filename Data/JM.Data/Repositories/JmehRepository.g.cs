...
namespace Infor.Sxe.JM.Data.Repositories
{
   ...
   public partial class JmehRepository : RepositoryBase
   {
      private JmehAdapter adapter;
  
      public JmehRepository(IProgressConnection connection)
      {
         this.adapter = new JmehAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, jobid, jobrevno, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByEnterdt(cono, enterdt, jobid, jobrevno, batchsize, fldList);
      }

      public IEnumerable<Jmeh> GetListByQuoteno(int cono, int quoteno, int jobrevno, int batchsize, string fldList)
      {
         return this.adapter.GetListByQuoteno(cono, quoteno, jobrevno, batchsize, fldList);
      }
      ...
      {
         return this.adapter.Lookup(jmjobheaderlookupcriteria);
      }
