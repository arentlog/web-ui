...
namespace Infor.Sxe.JM.Data.Repositories
{
   ...
   public partial class JmehcRepository : RepositoryBase
   {
      private JmehcAdapter adapter;
  
      public JmehcRepository(IProgressConnection connection)
      {
         this.adapter = new JmehcAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, jobid, jobrevno, custno, name, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByCustjob(cono, custno, name, jobid, jobrevno, batchsize, fldList);
      }
