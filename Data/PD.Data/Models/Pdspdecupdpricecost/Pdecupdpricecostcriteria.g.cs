...
{
   [ModelName("Infor.Sxe.PD.Data.Models.Pdspdecupdpricecost.Pdecupdpricecostcriteria")]
   public partial class Pdecupdpricecostcriteria : ModelBase
   {
      ...
      public static Pdecupdpricecostcriteria BuildPdecupdpricecostcriteriaFromRow(DataRow row)
      {
         Pdecupdpricecostcriteria entity = new Pdecupdpricecostcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromPdecupdpricecostcriteria(ref DataRow row, Pdecupdpricecostcriteria entity)
      {
