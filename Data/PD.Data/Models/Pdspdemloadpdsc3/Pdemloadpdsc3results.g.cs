...
{
   [ModelName("Infor.Sxe.PD.Data.Models.Pdspdemloadpdsc3.Pdemloadpdsc3results")]
   public partial class Pdemloadpdsc3results : ModelBase
   {
      ...
      public static Pdemloadpdsc3results BuildPdemloadpdsc3resultsFromRow(DataRow row)
      {
         Pdemloadpdsc3results entity = new Pdemloadpdsc3results();
      ...
      /// </summary>
      public static void UpdateRowFromPdemloadpdsc3results(ref DataRow row, Pdemloadpdsc3results entity)
      {
