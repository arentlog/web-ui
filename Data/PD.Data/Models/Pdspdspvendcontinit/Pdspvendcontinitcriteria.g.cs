...
{
   [ModelName("Infor.Sxe.PD.Data.Models.Pdspdspvendcontinit.Pdspvendcontinitcriteria")]
   public partial class Pdspvendcontinitcriteria : ModelBase
   {
      ...
      public static Pdspvendcontinitcriteria BuildPdspvendcontinitcriteriaFromRow(DataRow row)
      {
         Pdspvendcontinitcriteria entity = new Pdspvendcontinitcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromPdspvendcontinitcriteria(ref DataRow row, Pdspvendcontinitcriteria entity)
      {
