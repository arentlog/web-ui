...
{
   [ModelName("Infor.Sxe.PD.Data.Models.Pdspdergetreceipt.Pdergetreceiptresults")]
   public partial class Pdergetreceiptresults : ModelBase
   {
      ...
      [StringValidationAttribute]
      public string vendnotesf { get; set; }
      ...
      public static Pdergetreceiptresults BuildPdergetreceiptresultsFromRow(DataRow row)
      {
         Pdergetreceiptresults entity = new Pdergetreceiptresults();
         ...
         entity.vendnotesf = row.IsNull("vendnotesf") ? string.Empty : row.Field<string>("vendnotesf");
      ...
      /// </summary>
      public static void UpdateRowFromPdergetreceiptresults(ref DataRow row, Pdergetreceiptresults entity)
      {
         ...
         row.SetField("vendnotesf", entity.vendnotesf);
