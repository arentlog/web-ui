...
{
   [ModelName("Infor.Sxe.PD.Data.Models.Pdspdspcustprodcopy.Pdspcustprodcopycriteria")]
   public partial class Pdspcustprodcopycriteria : ModelBase
   {
      ...
      public static Pdspcustprodcopycriteria BuildPdspcustprodcopycriteriaFromRow(DataRow row)
      {
         Pdspcustprodcopycriteria entity = new Pdspcustprodcopycriteria();
      ...
      /// </summary>
      public static void UpdateRowFromPdspcustprodcopycriteria(ref DataRow row, Pdspcustprodcopycriteria entity)
      {
