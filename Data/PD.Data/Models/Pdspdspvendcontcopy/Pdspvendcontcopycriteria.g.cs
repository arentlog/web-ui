...
{
   [ModelName("Infor.Sxe.PD.Data.Models.Pdspdspvendcontcopy.Pdspvendcontcopycriteria")]
   public partial class Pdspvendcontcopycriteria : ModelBase
   {
      ...
      public static Pdspvendcontcopycriteria BuildPdspvendcontcopycriteriaFromRow(DataRow row)
      {
         Pdspvendcontcopycriteria entity = new Pdspvendcontcopycriteria();
      ...
      /// </summary>
      public static void UpdateRowFromPdspvendcontcopycriteria(ref DataRow row, Pdspvendcontcopycriteria entity)
      {
