...
namespace Infor.Sxe.PD.Data.Models.Complex
{
   ...
   public partial class AspdentryPDERDeltemprcptRequestAPI
   {
      public List<Pdergetclaimresults> pdergetclaimresults { get; set; }
      public Pdergetclaimcriteria pdergetclaimcriteria { get; set; }
 
    
      public AspdentryPDERDeltemprcptRequestAPI()
      {
