...
namespace Infor.Sxe.PV.Data.Repositories
{
   ...
   public partial class PvUserfieldsRepository : RepositoryBase
   {
      private PvUserfieldsAdapter adapter;
  
      public PvUserfieldsRepository(IProgressConnection connection)
      {
         this.adapter = new PvUserfieldsAdapter(connection);
      ...
      {
         return this.adapter.Get(tablename, fieldname, batchsize, fldList);
      }
