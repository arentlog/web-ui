...
namespace Infor.Sxe.PV.Data.Repositories
{
   ...
   public partial class PvSwewhRepository : RepositoryBase
   {
      private PvSwewhAdapter adapter;
  
      public PvSwewhRepository(IProgressConnection connection)
      {
         this.adapter = new PvSwewhAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, recjrnlno, intclaimno, swsuf, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByVendno(cono, recjrnlno, vendno, intclaimno, batchsize, fldList);
      }
