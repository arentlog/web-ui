...
namespace Infor.Sxe.RS.Data.Repositories
{
   ...
   public partial class RsaoRepository : RepositoryBase
   {
      private RsaoAdapter adapter;
  
      public RsaoRepository(IProgressConnection connection)
      {
         this.adapter = new RsaoAdapter(connection);
      ...
      {
         return this.adapter.Get(rsoper, batchsize, fldList);
      }
