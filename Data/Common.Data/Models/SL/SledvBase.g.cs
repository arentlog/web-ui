...
namespace Infor.Sxe.Common.Data.Models.SL
{
   ...
   public partial class SledvBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSledvBaseFromRow<T>(DataRow row) where T:SledvBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("sledvRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSledvBase(ref DataRow row, SledvBase entity)
      {
         ...
         row.SetField("sledvRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SledvBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("imptype", entity.imptype);
         row.SetField("slupdtno", entity.slupdtno);
