...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class AutodrpcfgBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildAutodrpcfgBaseFromRow<T>(DataRow row) where T:AutodrpcfgBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("autodrpcfgRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromAutodrpcfgBase(ref DataRow row, AutodrpcfgBase entity)
      {
         ...
         row.SetField("autodrpcfgRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, AutodrpcfgBase entity)
      {
