...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class OrderTypeBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildOrderTypeBaseFromRow<T>(DataRow row) where T:OrderTypeBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("order_typeRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromOrderTypeBase(ref DataRow row, OrderTypeBase entity)
      {
         ...
         row.SetField("order_typeRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, OrderTypeBase entity)
      {
         row.SetField("code", entity.code);
         row.SetField("order_typeRowID", entity.rowID.ToByteArray());
      }   
