...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class UdcalcTypeBase: ModelBase
   {
      ...
      /// </summary>
      [Key,Order]
      public bool udcActivefl { get; set; }
      ...
      /// </summary>
      public static T BuildUdcalcTypeBaseFromRow<T>(DataRow row) where T:UdcalcTypeBase, new()
      {
         T entity = new T();
         ...
         entity.udcActivefl = row.Field<bool>("udc_activefl");
         ...
         entity.rowID = row.Field<byte[]>("udcalc_typeRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromUdcalcTypeBase(ref DataRow row, UdcalcTypeBase entity)
      {
         row.SetField("co_num", entity.coNum);
         row.SetField("wh_num", entity.whNum);
         row.SetField("udc_type", entity.udcType);
         row.SetField("udc_desc", entity.udcDesc);
         row.SetField("udc_activefl", entity.udcActivefl);
         ...
         row.SetField("udcalc_typeRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, UdcalcTypeBase entity)
      {
         row.SetField("coNum", entity.coNum);
         row.SetField("whNum", entity.whNum);
         row.SetField("udcType", entity.udcType);
         row.SetField("udcActivefl", entity.udcActivefl);
         row.SetField("udcalc_typeRowID", entity.rowID.ToByteArray());
      }   
   }
}
