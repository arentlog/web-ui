...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class TransTypeBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildTransTypeBaseFromRow<T>(DataRow row) where T:TransTypeBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("trans_typeRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromTransTypeBase(ref DataRow row, TransTypeBase entity)
      {
         ...
         row.SetField("trans_typeRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, TransTypeBase entity)
      {
