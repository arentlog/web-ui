...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class RtTypeBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildRtTypeBaseFromRow<T>(DataRow row) where T:RtTypeBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("rt_typeRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromRtTypeBase(ref DataRow row, RtTypeBase entity)
      {
         ...
         row.SetField("rt_typeRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, RtTypeBase entity)
      {
         row.SetField("code", entity.code);
         row.SetField("rt_typeRowID", entity.rowID.ToByteArray());
      }   
