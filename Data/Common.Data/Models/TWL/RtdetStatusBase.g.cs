...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class RtdetStatusBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildRtdetStatusBaseFromRow<T>(DataRow row) where T:RtdetStatusBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("rtdet_statusRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromRtdetStatusBase(ref DataRow row, RtdetStatusBase entity)
      {
         ...
         row.SetField("rtdet_statusRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, RtdetStatusBase entity)
      {
         row.SetField("code", entity.code);
         row.SetField("rtdet_statusRowID", entity.rowID.ToByteArray());
      }   
