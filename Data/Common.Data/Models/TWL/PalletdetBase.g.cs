...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class PalletdetBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildPalletdetBaseFromRow<T>(DataRow row) where T:PalletdetBase, new()
      {
         T entity = new T();
         entity.palletNum = row.IsNull("pallet_num") ? 0 : row.Field<int>("pallet_num");
         entity.pickId = row.IsNull("pick_id") ? string.Empty : row.Field<string>("pick_id");
         ...
         entity.rowID = row.Field<byte[]>("palletdetRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPalletdetBase(ref DataRow row, PalletdetBase entity)
      {
         ...
         row.SetField("palletdetRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PalletdetBase entity)
      {
         row.SetField("palletdetRowID", entity.rowID.ToByteArray());
      }   
   }
