...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class ReturnReasonBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildReturnReasonBaseFromRow<T>(DataRow row) where T:ReturnReasonBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("return_reasonRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromReturnReasonBase(ref DataRow row, ReturnReasonBase entity)
      {
         ...
         row.SetField("return_reasonRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, ReturnReasonBase entity)
      {
