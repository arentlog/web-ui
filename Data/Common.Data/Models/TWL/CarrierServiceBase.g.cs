...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class CarrierServiceBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildCarrierServiceBaseFromRow<T>(DataRow row) where T:CarrierServiceBase, new()
      {
         T entity = new T();
         ...
         entity.defaultZone = row.IsNull("default_zone") ? string.Empty : row.Field<string>("default_zone");
         entity.carrierService = row.IsNull("carrier_service") ? string.Empty : row.Field<string>("carrier_service");
         entity.dateTime = row.IsNull("date_time") ? string.Empty : row.Field<string>("date_time");
         entity.ratePrg = row.IsNull("rate_prg") ? string.Empty : row.Field<string>("rate_prg");
         ...
         entity.comCode = row.IsNull("com_code") ? string.Empty : row.Field<string>("com_code");
         entity.transUser = row.IsNull("trans_user") ? string.Empty : row.Field<string>("trans_user");
         entity.transDate = row.IsNull("trans_date") ? string.Empty : row.Field<string>("trans_date");
         entity.transProc = row.IsNull("trans_proc") ? string.Empty : row.Field<string>("trans_proc");
         entity.rowID = row.Field<byte[]>("carrier_serviceRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromCarrierServiceBase(ref DataRow row, CarrierServiceBase entity)
      {
         row.SetField("co_num", entity.coNum);
         row.SetField("wh_num", entity.whNum);
         row.SetField("carrier_id", entity.carrierId);
         row.SetField("service", entity.service);
         row.SetField("default_zone", entity.defaultZone);
         row.SetField("carrier_service", entity.carrierService);
         row.SetField("date_time", entity.dateTime);
         row.SetField("rate_prg", entity.ratePrg);
         ...
         row.SetField("com_code", entity.comCode);
         row.SetField("trans_user", entity.transUser);
         row.SetField("trans_date", entity.transDate);
         row.SetField("trans_proc", entity.transProc);
         row.SetField("carrier_serviceRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, CarrierServiceBase entity)
      {
