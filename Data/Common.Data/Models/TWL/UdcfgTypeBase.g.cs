...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class UdcfgTypeBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildUdcfgTypeBaseFromRow<T>(DataRow row) where T:UdcfgTypeBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("udcfg_typeRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromUdcfgTypeBase(ref DataRow row, UdcfgTypeBase entity)
      {
         ...
         row.SetField("udcfg_typeRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, UdcfgTypeBase entity)
      {
         row.SetField("udcfg_typeRowID", entity.rowID.ToByteArray());
      }   
   }
