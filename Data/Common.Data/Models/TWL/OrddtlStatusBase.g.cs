...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class OrddtlStatusBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildOrddtlStatusBaseFromRow<T>(DataRow row) where T:OrddtlStatusBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("orddtl_statusRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromOrddtlStatusBase(ref DataRow row, OrddtlStatusBase entity)
      {
         ...
         row.SetField("orddtl_statusRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, OrddtlStatusBase entity)
      {
         row.SetField("code", entity.code);
         row.SetField("orddtl_statusRowID", entity.rowID.ToByteArray());
      }   
