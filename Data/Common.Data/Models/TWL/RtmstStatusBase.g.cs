...
namespace Infor.Sxe.Common.Data.Models.TWL
{
   ...
   public partial class RtmstStatusBase: ModelBase
   {
      ...
      /// </summary>
      public static T BuildRtmstStatusBaseFromRow<T>(DataRow row) where T:RtmstStatusBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("rtmst_statusRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromRtmstStatusBase(ref DataRow row, RtmstStatusBase entity)
      {
         ...
         row.SetField("rtmst_statusRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, RtmstStatusBase entity)
      {
         row.SetField("code", entity.code);
         row.SetField("rtmst_statusRowID", entity.rowID.ToByteArray());
      }   
