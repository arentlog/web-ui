...
namespace Infor.Sxe.Common.Data.Models.PD
{
   ...
   public partial class PdsfBase: ModelBase, IUserFields
   {
      ...
      /// Change Price by
      /// </summary>
      public decimal pricepct { get; set; }

      /// <summary>
      /// Pct/Dollar
      /// </summary>
      public bool pctfl { get; set; }
      ...
      /// </summary>
      public static T BuildPdsfBaseFromRow<T>(DataRow row) where T:PdsfBase, new()
      {
         T entity = new T();
         ...
         entity.pricepct = row.IsNull("pricepct") ? decimal.Zero : row.Field<decimal>("pricepct");
         entity.pctfl = row.Field<bool>("pctfl");
         ...
         entity.rowID = row.Field<byte[]>("pdsfRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPdsfBase(ref DataRow row, PdsfBase entity)
      {
         ...
         row.SetField("pricepct", entity.pricepct);
         row.SetField("pctfl", entity.pctfl);
         ...
         row.SetField("pdsfRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PdsfBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("prod", entity.prod);
         row.SetField("whse", entity.whse);
