...
namespace Infor.Sxe.Common.Data.Models.PD
{
   ...
   public partial class PdsvtrBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildPdsvtrBaseFromRow<T>(DataRow row) where T:PdsvtrBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("pdsvtrRowID").ToStringEncoded();
         return entity;
      }
