...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IcssBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIcssBaseFromRow<T>(DataRow row) where T:IcssBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("icssRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIcssBase(ref DataRow row, IcssBase entity)
      {
         ...
         row.SetField("icssRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IcssBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("prod", entity.prod);
         row.SetField("icspecrecno", entity.icspecrecno);
