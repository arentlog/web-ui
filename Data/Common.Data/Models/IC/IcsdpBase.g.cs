...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IcsdpBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIcsdpBaseFromRow<T>(DataRow row) where T:IcsdpBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("icsdpRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIcsdpBase(ref DataRow row, IcsdpBase entity)
      {
         ...
         row.SetField("icsdpRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IcsdpBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("whse", entity.whse);
         row.SetField("mediacd", entity.mediacd);
