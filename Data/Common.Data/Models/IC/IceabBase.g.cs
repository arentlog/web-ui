...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IceabBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIceabBaseFromRow<T>(DataRow row) where T:IceabBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("iceabRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIceabBase(ref DataRow row, IceabBase entity)
      {
         ...
         row.SetField("iceabRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IceabBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("custno", entity.custno);
         row.SetField("shipto", entity.shipto);
