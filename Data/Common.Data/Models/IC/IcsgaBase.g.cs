...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IcsgaBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIcsgaBaseFromRow<T>(DataRow row) where T:IcsgaBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("icsgaRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIcsgaBase(ref DataRow row, IcsgaBase entity)
      {
         ...
         row.SetField("icsgaRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IcsgaBase entity)
      {
         row.SetField("attrno", entity.attrno);
         row.SetField("groupno", entity.groupno);
         row.SetField("icsgaRowID", entity.rowID.ToByteArray());
