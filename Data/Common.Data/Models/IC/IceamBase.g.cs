...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IceamBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIceamBaseFromRow<T>(DataRow row) where T:IceamBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("iceamRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIceamBase(ref DataRow row, IceamBase entity)
      {
         ...
         row.SetField("iceamRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IceamBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("transty", entity.transty);
         row.SetField("orderno", entity.orderno);
