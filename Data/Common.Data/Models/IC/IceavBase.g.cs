...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IceavBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIceavBaseFromRow<T>(DataRow row) where T:IceavBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("iceavRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIceavBase(ref DataRow row, IceavBase entity)
      {
         ...
         row.SetField("iceavRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IceavBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("whse", entity.whse);
         row.SetField("origprod", entity.origprod);
