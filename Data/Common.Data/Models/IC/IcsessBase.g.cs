...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IcsessBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIcsessBaseFromRow<T>(DataRow row) where T:IcsessBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("icsessRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIcsessBase(ref DataRow row, IcsessBase entity)
      {
         ...
         row.SetField("icsessRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IcsessBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("vendno", entity.vendno);
         row.SetField("rectype", entity.rectype);
