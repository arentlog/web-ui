...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   /// </summary>
   [EntityType("IC Customer Inventory Transaction Entry","TBD","")]
   public partial class IcetcBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIcetcBaseFromRow<T>(DataRow row) where T:IcetcBase, new()
      {
         T entity = new T();
         ...
         entity.icseqno = row.IsNull("icseqno") ? 0 : row.Field<int>("icseqno");
         ...
         entity.rowID = row.Field<byte[]>("icetcRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIcetcBase(ref DataRow row, IcetcBase entity)
      {
         ...
         row.SetField("icseqno", entity.icseqno);
         ...
         row.SetField("icetcRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IcetcBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("whse", entity.whse);
         row.SetField("prod", entity.prod);
