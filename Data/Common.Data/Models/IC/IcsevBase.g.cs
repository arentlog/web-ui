...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IcsevBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIcsevBaseFromRow<T>(DataRow row) where T:IcsevBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("icsevRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIcsevBase(ref DataRow row, IcsevBase entity)
      {
         ...
         row.SetField("icsevRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IcsevBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("lifocat", entity.lifocat);
         row.SetField("yr", entity.yr);
