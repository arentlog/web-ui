...
namespace Infor.Sxe.Common.Data.Models.IC
{
   ...
   public partial class IcamapmBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildIcamapmBaseFromRow<T>(DataRow row) where T:IcamapmBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("icamapmRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromIcamapmBase(ref DataRow row, IcamapmBase entity)
      {
         ...
         row.SetField("icamapmRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, IcamapmBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("reportno", entity.reportno);
         row.SetField("whse", entity.whse);
