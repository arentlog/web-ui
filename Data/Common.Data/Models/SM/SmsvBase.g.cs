...
namespace Infor.Sxe.Common.Data.Models.SM
{
   ...
   public partial class SmsvBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSmsvBaseFromRow<T>(DataRow row) where T:SmsvBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("smsvRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSmsvBase(ref DataRow row, SmsvBase entity)
      {
         ...
         row.SetField("smsvRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SmsvBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("vendno", entity.vendno);
         row.SetField("yr", entity.yr);
