...
namespace Infor.Sxe.Common.Data.Models.SM
{
   ...
   public partial class SmsvpBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSmsvpBaseFromRow<T>(DataRow row) where T:SmsvpBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("smsvpRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSmsvpBase(ref DataRow row, SmsvpBase entity)
      {
         ...
         row.SetField("smsvpRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SmsvpBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("yr", entity.yr);
         row.SetField("vendno", entity.vendno);
