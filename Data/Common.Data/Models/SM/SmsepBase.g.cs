...
namespace Infor.Sxe.Common.Data.Models.SM
{
   ...
   public partial class SmsepBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSmsepBaseFromRow<T>(DataRow row) where T:SmsepBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("smsepRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSmsepBase(ref DataRow row, SmsepBase entity)
      {
         ...
         row.SetField("smsepRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SmsepBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("yr", entity.yr);
         row.SetField("custno", entity.custno);
