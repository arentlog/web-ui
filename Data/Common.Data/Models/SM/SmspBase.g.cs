...
namespace Infor.Sxe.Common.Data.Models.SM
{
   ...
   public partial class SmspBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSmspBaseFromRow<T>(DataRow row) where T:SmspBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("smspRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSmspBase(ref DataRow row, SmspBase entity)
      {
         ...
         row.SetField("smspRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SmspBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("prodcat", entity.prodcat);
         row.SetField("yr", entity.yr);
