...
namespace Infor.Sxe.Common.Data.Models.SM
{
   ...
   public partial class SmsewBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSmsewBaseFromRow<T>(DataRow row) where T:SmsewBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("smsewRowID").ToStringEncoded();
         return entity;
      }
