...
namespace Infor.Sxe.Common.Data.Models.SM
{
   ...
   public partial class SmswBase: ModelBase, IUserFields
   {
      ...
      /// Units Lost
      /// </summary>
      public decimal qtylost1 { get; set; }
      public decimal qtylost2 { get; set; }
      public decimal qtylost3 { get; set; }
      public decimal qtylost4 { get; set; }
      public decimal qtylost5 { get; set; }
      public decimal qtylost6 { get; set; }
      public decimal qtylost7 { get; set; }
      public decimal qtylost8 { get; set; }
      public decimal qtylost9 { get; set; }
      public decimal qtylost10 { get; set; }
      public decimal qtylost11 { get; set; }
      public decimal qtylost12 { get; set; }
      public decimal qtylost13 { get; set; }
      ...
      /// </summary>
      public static T BuildSmswBaseFromRow<T>(DataRow row) where T:SmswBase, new()
      {
         T entity = new T();
         ...
         entity.qtylost1 = row.IsNull("qtylost1") ? decimal.Zero : row.Field<decimal>("qtylost1");
         entity.qtylost2 = row.IsNull("qtylost2") ? decimal.Zero : row.Field<decimal>("qtylost2");
         entity.qtylost3 = row.IsNull("qtylost3") ? decimal.Zero : row.Field<decimal>("qtylost3");
         entity.qtylost4 = row.IsNull("qtylost4") ? decimal.Zero : row.Field<decimal>("qtylost4");
         entity.qtylost5 = row.IsNull("qtylost5") ? decimal.Zero : row.Field<decimal>("qtylost5");
         entity.qtylost6 = row.IsNull("qtylost6") ? decimal.Zero : row.Field<decimal>("qtylost6");
         entity.qtylost7 = row.IsNull("qtylost7") ? decimal.Zero : row.Field<decimal>("qtylost7");
         entity.qtylost8 = row.IsNull("qtylost8") ? decimal.Zero : row.Field<decimal>("qtylost8");
         entity.qtylost9 = row.IsNull("qtylost9") ? decimal.Zero : row.Field<decimal>("qtylost9");
         entity.qtylost10 = row.IsNull("qtylost10") ? decimal.Zero : row.Field<decimal>("qtylost10");
         entity.qtylost11 = row.IsNull("qtylost11") ? decimal.Zero : row.Field<decimal>("qtylost11");
         entity.qtylost12 = row.IsNull("qtylost12") ? decimal.Zero : row.Field<decimal>("qtylost12");
         entity.qtylost13 = row.IsNull("qtylost13") ? decimal.Zero : row.Field<decimal>("qtylost13");
         ...
         entity.rowID = row.Field<byte[]>("smswRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSmswBase(ref DataRow row, SmswBase entity)
      {
         ...
         row.SetField("qtylost1", entity.qtylost1);
         row.SetField("qtylost2", entity.qtylost2);
         row.SetField("qtylost3", entity.qtylost3);
         row.SetField("qtylost4", entity.qtylost4);
         row.SetField("qtylost5", entity.qtylost5);
         row.SetField("qtylost6", entity.qtylost6);
         row.SetField("qtylost7", entity.qtylost7);
         row.SetField("qtylost8", entity.qtylost8);
         row.SetField("qtylost9", entity.qtylost9);
         row.SetField("qtylost10", entity.qtylost10);
         row.SetField("qtylost11", entity.qtylost11);
         row.SetField("qtylost12", entity.qtylost12);
         row.SetField("qtylost13", entity.qtylost13);
         ...
         row.SetField("smswRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SmswBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("prod", entity.prod);
         row.SetField("whse", entity.whse);
