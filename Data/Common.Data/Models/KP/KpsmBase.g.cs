...
namespace Infor.Sxe.Common.Data.Models.KP
{
   ...
   public partial class KpsmBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildKpsmBaseFromRow<T>(DataRow row) where T:KpsmBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("kpsmRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromKpsmBase(ref DataRow row, KpsmBase entity)
      {
         ...
         row.SetField("kpsmRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, KpsmBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("prod", entity.prod);
         row.SetField("whse", entity.whse);
