...
namespace Infor.Sxe.Common.Data.Models.KP
{
   ...
   public partial class KpskvBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildKpskvBaseFromRow<T>(DataRow row) where T:KpskvBase, new()
      {
         T entity = new T();
         ...
         entity.compfl = row.Field<bool>("compfl");
         ...
         entity.rowID = row.Field<byte[]>("kpskvRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromKpskvBase(ref DataRow row, KpskvBase entity)
      {
         ...
         row.SetField("compfl", entity.compfl);
         ...
         row.SetField("kpskvRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, KpskvBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("prod", entity.prod);
         row.SetField("verno", entity.verno);
