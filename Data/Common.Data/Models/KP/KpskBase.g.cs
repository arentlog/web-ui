...
namespace Infor.Sxe.Common.Data.Models.KP
{
   ...
   public partial class KpskBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildKpskBaseFromRow<T>(DataRow row) where T:KpskBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("kpskRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromKpskBase(ref DataRow row, KpskBase entity)
      {
         ...
         row.SetField("kpskRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, KpskBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("prod", entity.prod);
         row.SetField("seqno", entity.seqno);
