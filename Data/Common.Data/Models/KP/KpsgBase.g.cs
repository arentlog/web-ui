...
namespace Infor.Sxe.Common.Data.Models.KP
{
   ...
   public partial class KpsgBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildKpsgBaseFromRow<T>(DataRow row) where T:KpsgBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("kpsgRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromKpsgBase(ref DataRow row, KpsgBase entity)
      {
         ...
         row.SetField("kpsgRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, KpsgBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("groupname", entity.groupname);
         row.SetField("seqno", entity.seqno);
