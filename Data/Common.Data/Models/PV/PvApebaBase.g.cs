...
namespace Infor.Sxe.Common.Data.Models.PV
{
   ...
   public partial class PvApebaBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildPvApebaBaseFromRow<T>(DataRow row) where T:PvApebaBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("pv_apebaRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPvApebaBase(ref DataRow row, PvApebaBase entity)
      {
         ...
         row.SetField("pv_apebaRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PvApebaBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("batchnm", entity.batchnm);
         row.SetField("setno", entity.setno);
