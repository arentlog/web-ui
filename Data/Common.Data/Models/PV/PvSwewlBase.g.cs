...
namespace Infor.Sxe.Common.Data.Models.PV
{
   ...
   public partial class PvSwewlBase: ModelBase, IUserFields
   {
      ...
      /// resubqty
      /// </summary>
      public decimal resubqty { get; set; }

      /// <summary>
      /// totresubamt
      /// </summary>
      public decimal totresubamt { get; set; }
      ...
      /// </summary>
      public static T BuildPvSwewlBaseFromRow<T>(DataRow row) where T:PvSwewlBase, new()
      {
         T entity = new T();
         ...
         entity.resubqty = row.IsNull("resubqty") ? decimal.Zero : row.Field<decimal>("resubqty");
         entity.totresubamt = row.IsNull("totresubamt") ? decimal.Zero : row.Field<decimal>("totresubamt");
         ...
         entity.rowID = row.Field<byte[]>("pv_swewlRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPvSwewlBase(ref DataRow row, PvSwewlBase entity)
      {
         ...
         row.SetField("resubqty", entity.resubqty);
         row.SetField("totresubamt", entity.totresubamt);
         ...
         row.SetField("pv_swewlRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PvSwewlBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("lineno", entity.lineno);
         row.SetField("intclaimno", entity.intclaimno);
