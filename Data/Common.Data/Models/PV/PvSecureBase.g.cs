...
namespace Infor.Sxe.Common.Data.Models.PV
{
   ...
   public partial class PvSecureBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      [StringValidationAttribute]
      public string folderSecurity { get; set; }
      ...
      /// </summary>
      public static T BuildPvSecureBaseFromRow<T>(DataRow row) where T:PvSecureBase, new()
      {
         T entity = new T();
         entity.cono = row.IsNull("cono") ? 0 : row.Field<int>("cono");
         entity.operinit = row.IsNull("operinit") ? string.Empty : row.Field<string>("operinit");
         entity.functionName = row.IsNull("FunctionName") ? string.Empty : row.Field<string>("FunctionName");
         entity.folderSecurity = row.IsNull("FolderSecurity") ? string.Empty : row.Field<string>("FolderSecurity");
         ...
         entity.origname = row.IsNull("origname") ? string.Empty : row.Field<string>("origname");
         entity.rowID = row.Field<byte[]>("pv_secureRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPvSecureBase(ref DataRow row, PvSecureBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("operinit", entity.operinit);
         row.SetField("FunctionName", entity.functionName);
         row.SetField("FolderSecurity", entity.folderSecurity);
         ...
         row.SetField("origname", entity.origname);
         row.SetField("pv_secureRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PvSecureBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("functionName", entity.functionName);
         row.SetField("oper2", entity.oper2);
