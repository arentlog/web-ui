...
namespace Infor.Sxe.Common.Data.Models.PV
{
   ...
   public partial class PvApebcBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildPvApebcBaseFromRow<T>(DataRow row) where T:PvApebcBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("pv_apebcRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPvApebcBase(ref DataRow row, PvApebcBase entity)
      {
         ...
         row.SetField("pv_apebcRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PvApebcBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("pono", entity.pono);
         row.SetField("batchnm", entity.batchnm);
