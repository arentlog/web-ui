...
namespace Infor.Sxe.Common.Data.Models.PV
{
   ...
   public partial class PvRecoveryBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildPvRecoveryBaseFromRow<T>(DataRow row) where T:PvRecoveryBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("pv_recoveryRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPvRecoveryBase(ref DataRow row, PvRecoveryBase entity)
      {
         ...
         row.SetField("pv_recoveryRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PvRecoveryBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("oper2", entity.oper2);
         row.SetField("functionname", entity.functionname);
