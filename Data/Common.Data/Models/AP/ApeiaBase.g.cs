...
namespace Infor.Sxe.Common.Data.Models.AP
{
   ...
   public partial class ApeiaBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildApeiaBaseFromRow<T>(DataRow row) where T:ApeiaBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("apeiaRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromApeiaBase(ref DataRow row, ApeiaBase entity)
      {
         ...
         row.SetField("apeiaRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, ApeiaBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("groupnm", entity.groupnm);
         row.SetField("createddt", entity.createddt);
