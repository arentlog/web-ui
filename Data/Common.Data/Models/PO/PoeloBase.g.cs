...
namespace Infor.Sxe.Common.Data.Models.PO
{
   ...
   /// </summary>
   [EntityType("PO Line Item Order File","TBD","")]
   public partial class PoeloBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildPoeloBaseFromRow<T>(DataRow row) where T:PoeloBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("poeloRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPoeloBase(ref DataRow row, PoeloBase entity)
      {
         ...
         row.SetField("poeloRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PoeloBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("pono", entity.pono);
         row.SetField("lineno", entity.lineno);
