...
namespace Infor.Sxe.Common.Data.Models.PO
{
   ...
   public partial class PoelbBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildPoelbBaseFromRow<T>(DataRow row) where T:PoelbBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("poelbRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromPoelbBase(ref DataRow row, PoelbBase entity)
      {
         ...
         row.SetField("poelbRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, PoelbBase entity)
      {
         row.SetField("pono", entity.pono);
         row.SetField("posuf", entity.posuf);
         row.SetField("lineno", entity.lineno);
