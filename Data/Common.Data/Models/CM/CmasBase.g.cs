...
namespace Infor.Sxe.Common.Data.Models.CM
{
   ...
   public partial class CmasBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildCmasBaseFromRow<T>(DataRow row) where T:CmasBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("cmasRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromCmasBase(ref DataRow row, CmasBase entity)
      {
         ...
         row.SetField("cmasRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, CmasBase entity)
      {
         row.SetField("slsrepin", entity.slsrepin);
         row.SetField("slsrepout", entity.slsrepout);
         row.SetField("prostype", entity.prostype);
