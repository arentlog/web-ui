...
namespace Infor.Sxe.Common.Data.Models.CM
{
   ...
   public partial class CmstBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildCmstBaseFromRow<T>(DataRow row) where T:CmstBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("cmstRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromCmstBase(ref DataRow row, CmstBase entity)
      {
         ...
         row.SetField("cmstRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, CmstBase entity)
      {
         row.SetField("codeiden", entity.codeiden);
         row.SetField("codeval", entity.codeval);
         row.SetField("slsrep", entity.slsrep);
