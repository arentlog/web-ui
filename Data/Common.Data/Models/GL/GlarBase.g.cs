...
namespace Infor.Sxe.Common.Data.Models.GL
{
   ...
   public partial class GlarBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildGlarBaseFromRow<T>(DataRow row) where T:GlarBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("glarRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromGlarBase(ref DataRow row, GlarBase entity)
      {
         ...
         row.SetField("glarRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, GlarBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("revalno", entity.revalno);
         row.SetField("glarRowID", entity.rowID.ToByteArray());
