...
namespace Infor.Sxe.Common.Data.Models.JM
{
   ...
   public partial class JmelBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildJmelBaseFromRow<T>(DataRow row) where T:JmelBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("jmelRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromJmelBase(ref DataRow row, JmelBase entity)
      {
         ...
         row.SetField("jmelRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, JmelBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("jobid", entity.jobid);
         row.SetField("jobrevno", entity.jobrevno);
