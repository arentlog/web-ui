...
namespace Infor.Sxe.Common.Data.Models.SHARED
{
   ...
   public partial class AodataBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildAodataBaseFromRow<T>(DataRow row) where T:AodataBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("aodataRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromAodataBase(ref DataRow row, AodataBase entity)
      {
         ...
         row.SetField("aodataRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, AodataBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("recordtype", entity.recordtype);
         row.SetField("fieldname", entity.fieldname);
