...
namespace Infor.Sxe.Common.Data.Models.SHARED
{
   ...
   public partial class EventActivateBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildEventActivateBaseFromRow<T>(DataRow row) where T:EventActivateBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("event_activateRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromEventActivateBase(ref DataRow row, EventActivateBase entity)
      {
         ...
         row.SetField("event_activateRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, EventActivateBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("eventname", entity.eventname);
         row.SetField("triggername", entity.triggername);
