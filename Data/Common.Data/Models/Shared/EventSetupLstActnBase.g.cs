...
namespace Infor.Sxe.Common.Data.Models.SHARED
{
   ...
   public partial class EventSetupLstActnBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildEventSetupLstActnBaseFromRow<T>(DataRow row) where T:EventSetupLstActnBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("event_setup_lst_actnRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromEventSetupLstActnBase(ref DataRow row, EventSetupLstActnBase entity)
      {
         ...
         row.SetField("event_setup_lst_actnRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, EventSetupLstActnBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("eventname", entity.eventname);
         row.SetField("actionseqno", entity.actionseqno);
