...
namespace Infor.Sxe.Common.Data.Models.SHARED
{
   ...
   public partial class CcpreauthBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildCcpreauthBaseFromRow<T>(DataRow row) where T:CcpreauthBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("ccpreauthRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromCcpreauthBase(ref DataRow row, CcpreauthBase entity)
      {
         ...
         row.SetField("ccpreauthRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, CcpreauthBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("custno", entity.custno);
         row.SetField("shipto", entity.shipto);
