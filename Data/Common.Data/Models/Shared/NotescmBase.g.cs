...
namespace Infor.Sxe.Common.Data.Models.SHARED
{
   ...
   public partial class NotescmBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildNotescmBaseFromRow<T>(DataRow row) where T:NotescmBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("notescmRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromNotescmBase(ref DataRow row, NotescmBase entity)
      {
         ...
         row.SetField("notescmRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, NotescmBase entity)
      {
         row.SetField("notestype", entity.notestype);
         row.SetField("primarykey", entity.primarykey);
         row.SetField("pageno", entity.pageno);
