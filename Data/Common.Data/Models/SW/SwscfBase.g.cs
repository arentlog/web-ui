...
namespace Infor.Sxe.Common.Data.Models.SW
{
   ...
   public partial class SwscfBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSwscfBaseFromRow<T>(DataRow row) where T:SwscfBase, new()
      {
         T entity = new T();
         ...
         entity.failtxt = row.IsNull("failtxt") ? string.Empty : row.Field<string>("failtxt");
         ...
         entity.rowID = row.Field<byte[]>("swscfRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSwscfBase(ref DataRow row, SwscfBase entity)
      {
         ...
         row.SetField("failtxt", entity.failtxt);
         ...
         row.SetField("swscfRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SwscfBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("failcd", entity.failcd);
         row.SetField("vendno", entity.vendno);
