...
namespace Infor.Sxe.Common.Data.Models.AR
{
   ...
   public partial class ArsptBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildArsptBaseFromRow<T>(DataRow row) where T:ArsptBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("arsptRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromArsptBase(ref DataRow row, ArsptBase entity)
      {
         ...
         row.SetField("arsptRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, ArsptBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("custno", entity.custno);
         row.SetField("shipto", entity.shipto);
