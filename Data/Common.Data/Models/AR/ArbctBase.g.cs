...
namespace Infor.Sxe.Common.Data.Models.AR
{
   ...
   public partial class ArbctBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildArbctBaseFromRow<T>(DataRow row) where T:ArbctBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("arbctRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromArbctBase(ref DataRow row, ArbctBase entity)
      {
         ...
         row.SetField("arbctRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, ArbctBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("transmission", entity.transmission);
         row.SetField("arbctRowID", entity.rowID.ToByteArray());
