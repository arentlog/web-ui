...
namespace Infor.Sxe.Common.Data.Models.RS
{
   ...
   public partial class RssjcBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildRssjcBaseFromRow<T>(DataRow row) where T:RssjcBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("rssjcRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromRssjcBase(ref DataRow row, RssjcBase entity)
      {
         ...
         row.SetField("rssjcRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, RssjcBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("groupnm", entity.groupnm);
         row.SetField("componentnm", entity.componentnm);
