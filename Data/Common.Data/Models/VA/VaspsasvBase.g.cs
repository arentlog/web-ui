...
namespace Infor.Sxe.Common.Data.Models.VA
{
   ...
   public partial class VaspsasvBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildVaspsasvBaseFromRow<T>(DataRow row) where T:VaspsasvBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("vaspsasvRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromVaspsasvBase(ref DataRow row, VaspsasvBase entity)
      {
         ...
         row.SetField("vaspsasvRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, VaspsasvBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("shipprod", entity.shipprod);
         row.SetField("whse", entity.whse);
