...
namespace Infor.Sxe.Common.Data.Models.VA
{
   ...
   public partial class VaeloBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildVaeloBaseFromRow<T>(DataRow row) where T:VaeloBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("vaeloRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromVaeloBase(ref DataRow row, VaeloBase entity)
      {
         ...
         row.SetField("vaeloRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, VaeloBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("vano", entity.vano);
         row.SetField("lineno", entity.lineno);
