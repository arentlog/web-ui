...
namespace Infor.Sxe.Common.Data.Models.VA
{
   ...
   public partial class VaspsasrvBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildVaspsasrvBaseFromRow<T>(DataRow row) where T:VaspsasrvBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("vaspsasrvRowID").ToStringEncoded();
         return entity;
      }
