...
namespace Infor.Sxe.Common.Data.Models.VA
{
   ...
   public partial class VaspsavBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildVaspsavBaseFromRow<T>(DataRow row) where T:VaspsavBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("vaspsavRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromVaspsavBase(ref DataRow row, VaspsavBase entity)
      {
         ...
         row.SetField("vaspsavRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, VaspsavBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("shipprod", entity.shipprod);
         row.SetField("whse", entity.whse);
