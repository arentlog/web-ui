...
namespace Infor.Sxe.Common.Data.Models.VA
{
   ...
   public partial class VastBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildVastBaseFromRow<T>(DataRow row) where T:VastBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("vastRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromVastBase(ref DataRow row, VastBase entity)
      {
         ...
         row.SetField("vastRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, VastBase entity)
      {
         row.SetField("codeiden", entity.codeiden);
         row.SetField("codeval", entity.codeval);
         row.SetField("cono", entity.cono);
