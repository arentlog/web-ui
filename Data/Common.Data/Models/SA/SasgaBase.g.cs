...
namespace Infor.Sxe.Common.Data.Models.SA
{
   ...
   public partial class SasgaBase: ModelBase, IUserFields
   {
      ...
      /// Addon Tax Group
      /// </summary>
      public int addontaxgroup { get; set; }
      ...
      /// </summary>
      public static T BuildSasgaBaseFromRow<T>(DataRow row) where T:SasgaBase, new()
      {
         T entity = new T();
         entity.cono = row.IsNull("cono") ? 0 : row.Field<int>("cono");
         entity.tablety = row.IsNull("tablety") ? string.Empty : row.Field<string>("tablety");
         ...
         entity.addontaxgroup = row.IsNull("addontaxgroup") ? 0 : row.Field<int>("addontaxgroup");
         ...
         entity.rowID = row.Field<byte[]>("sasgaRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSasgaBase(ref DataRow row, SasgaBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("tablety", entity.tablety);
         row.SetField("recty", entity.recty);
         row.SetField("statecd", entity.statecd);
         row.SetField("addontaxgroup", entity.addontaxgroup);
         ...
         row.SetField("sasgaRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SasgaBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("tablety", entity.tablety);
         row.SetField("recty", entity.recty);
