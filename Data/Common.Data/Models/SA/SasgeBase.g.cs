...
namespace Infor.Sxe.Common.Data.Models.SA
{
   ...
   public partial class SasgeBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSasgeBaseFromRow<T>(DataRow row) where T:SasgeBase, new()
      {
         T entity = new T();
         ...
         entity.taxfl = row.Field<bool>("taxfl");
         ...
         entity.rowID = row.Field<byte[]>("sasgeRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSasgeBase(ref DataRow row, SasgeBase entity)
      {
         ...
         row.SetField("taxfl", entity.taxfl);
         ...
         row.SetField("sasgeRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SasgeBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("custno", entity.custno);
         row.SetField("shipto", entity.shipto);
