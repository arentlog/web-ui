...
namespace Infor.Sxe.Common.Data.Models.SA
{
   ...
   public partial class SapbcBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSapbcBaseFromRow<T>(DataRow row) where T:SapbcBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("sapbcRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSapbcBase(ref DataRow row, SapbcBase entity)
      {
         ...
         row.SetField("sapbcRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SapbcBase entity)
      {
         row.SetField("reportnm", entity.reportnm);
         row.SetField("cono", entity.cono);
         row.SetField("custno", entity.custno);
