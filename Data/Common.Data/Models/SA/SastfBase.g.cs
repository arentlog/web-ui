...
namespace Infor.Sxe.Common.Data.Models.SA
{
   ...
   public partial class SastfBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSastfBaseFromRow<T>(DataRow row) where T:SastfBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("sastfRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSastfBase(ref DataRow row, SastfBase entity)
      {
         ...
         row.SetField("sastfRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SastfBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("billlevelcd", entity.billlevelcd);
         row.SetField("srcrowpointer", entity.srcrowpointer);
