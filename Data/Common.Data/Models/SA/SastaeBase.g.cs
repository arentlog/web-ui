...
namespace Infor.Sxe.Common.Data.Models.SA
{
   ...
   public partial class SastaeBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSastaeBaseFromRow<T>(DataRow row) where T:SastaeBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("sastaeRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSastaeBase(ref DataRow row, SastaeBase entity)
      {
         ...
         row.SetField("sastaeRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SastaeBase entity)
      {
         row.SetField("cono", entity.cono);
         row.SetField("codeiden", entity.codeiden);
         row.SetField("codeval", entity.codeval);
