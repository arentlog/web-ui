...
namespace Infor.Sxe.Common.Data.Models.SA
{
   ...
   public partial class SapbjBase: ModelBase, IUserFields
   {
      ...
      /// </summary>
      public static T BuildSapbjBaseFromRow<T>(DataRow row) where T:SapbjBase, new()
      {
         T entity = new T();
         ...
         entity.rowID = row.Field<byte[]>("sapbjRowID").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromSapbjBase(ref DataRow row, SapbjBase entity)
      {
         ...
         row.SetField("sapbjRowID", entity.rowID.ToByteArray());
      }   
      
      /// <summary>
      /// Build a minimal row from a class (key fields only)
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, SapbjBase entity)
      {
         row.SetField("jrnlno", entity.jrnlno);
         row.SetField("reportnm", entity.reportnm);
         row.SetField("cono", entity.cono);
