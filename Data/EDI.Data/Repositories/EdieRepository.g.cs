...
namespace Infor.Sxe.EDI.Data.Repositories
{
   ...
   public partial class EdieRepository : RepositoryBase
   {
      private EdieAdapter adapter;
  
      public EdieRepository(IProgressConnection connection)
      {
         this.adapter = new EdieAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, batchnm, seqno, level, lineno, errseqno, docty, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByCustno(cono, custno, whse, docty, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByEdiline(cono, batchnm, seqno, level, edilineno, batchsize, fldList);
      }

      public IEnumerable<Edie> GetListByErrty(int cono, string whse, string errty, string docty, int batchsize, string fldList)
      {
         return this.adapter.GetListByErrty(cono, whse, errty, docty, batchsize, fldList);
      }

      public IEnumerable<Edie> GetListByWhse(int cono, string whse, string docty, int batchsize, string fldList)
      {
         return this.adapter.GetListByWhse(cono, whse, docty, batchsize, fldList);
      }
