...
namespace Infor.Sxe.BI.Data.Repositories
{
   ...
   public partial class BiskRepository : RepositoryBase
   {
      private BiskAdapter adapter;
  
      public BiskRepository(IProgressConnection connection)
      {
         this.adapter = new BiskAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, kpi, batchsize, fldList);
      }
