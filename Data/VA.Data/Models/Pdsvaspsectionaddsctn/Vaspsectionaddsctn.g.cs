...
namespace Infor.Sxe.VA.Data.Models.Pdsvaspsectionaddsctn
{
   [ModelName("Infor.Sxe.VA.Data.Models.Pdsvaspsectionaddsctn.Vaspsectionaddsctn")]
   public partial class Vaspsectionaddsctn : ModelBase
   {
      ...
      public static Vaspsectionaddsctn BuildVaspsectionaddsctnFromRow(DataRow row)
      {
         Vaspsectionaddsctn entity = new Vaspsectionaddsctn();
      ...
      /// </summary>
      public static void UpdateRowFromVaspsectionaddsctn(ref DataRow row, Vaspsectionaddsctn entity)
      {
