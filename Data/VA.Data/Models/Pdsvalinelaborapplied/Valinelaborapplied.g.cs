...
{
   [ModelName("Infor.Sxe.VA.Data.Models.Pdsvalinelaborapplied.Valinelaborapplied")]
   public partial class Valinelaborapplied : ModelBase
   {
      ...
      public static Valinelaborapplied BuildValinelaborappliedFromRow(DataRow row)
      {
         Valinelaborapplied entity = new Valinelaborapplied();
         ...
         entity.oldnetamt = row.IsNull("oldnetamt") ? decimal.Zero : row.Field<decimal>("oldnetamt");
         entity.esttime = row.IsNull("esttime") ? string.Empty : row.Field<string>("esttime");
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromValinelaborapplied(ref DataRow row, Valinelaborapplied entity)
      {
         ...
         row.SetField("oldnetamt", entity.oldnetamt);
         row.SetField("esttime", entity.esttime);
