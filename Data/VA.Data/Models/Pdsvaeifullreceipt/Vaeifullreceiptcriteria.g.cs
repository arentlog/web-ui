...
namespace Infor.Sxe.VA.Data.Models.Pdsvaeifullreceipt
{
   [ModelName("Infor.Sxe.VA.Data.Models.Pdsvaeifullreceipt.Vaeifullreceiptcriteria")]
   public partial class Vaeifullreceiptcriteria : ModelBase
   {
      ...
      public static Vaeifullreceiptcriteria BuildVaeifullreceiptcriteriaFromRow(DataRow row)
      {
         Vaeifullreceiptcriteria entity = new Vaeifullreceiptcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromVaeifullreceiptcriteria(ref DataRow row, Vaeifullreceiptcriteria entity)
      {
