...
{
   [ModelName("Infor.Sxe.VA.Data.Models.Pdsvaaddons.Vaaddoncriteria")]
   public partial class Vaaddoncriteria : ModelBase
   {
      ...
      public static Vaaddoncriteria BuildVaaddoncriteriaFromRow(DataRow row)
      {
         Vaaddoncriteria entity = new Vaaddoncriteria();
      ...
      /// </summary>
      public static void UpdateRowFromVaaddoncriteria(ref DataRow row, Vaaddoncriteria entity)
      {
