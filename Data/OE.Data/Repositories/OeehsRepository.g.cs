...
namespace Infor.Sxe.OE.Data.Repositories
{
   ...
   public partial class OeehsRepository : RepositoryBase
   {
      private OeehsAdapter adapter;
  
      public OeehsRepository(IProgressConnection connection)
      {
         this.adapter = new OeehsAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, orderno, ordersuf, pricetype, batchsize, fldList);
      }
