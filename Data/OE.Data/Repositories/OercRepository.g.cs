...
namespace Infor.Sxe.OE.Data.Repositories
{
   ...
   public partial class OercRepository : RepositoryBase
   {
      private OercAdapter adapter;
  
      public OercRepository(IProgressConnection connection)
      {
         this.adapter = new OercAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, invno, invsuf, batchsize, fldList);
      }
