...
namespace Infor.Sxe.OE.Data.Repositories
{
   ...
   public partial class OeehqpRepository : RepositoryBase
   {
      private OeehqpAdapter adapter;
  
      public OeehqpRepository(IProgressConnection connection)
      {
         this.adapter = new OeehqpAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, orderno, ordersuf, type, typekey, vendno, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByLineno(cono, orderno, ordersuf, lineno, batchsize, fldList);
      }

      public IEnumerable<Oeehqp> GetListByVendno(int cono, decimal vendno, string typekey, int batchsize, string fldList)
      {
         return this.adapter.GetListByVendno(cono, vendno, typekey, batchsize, fldList);
      }
