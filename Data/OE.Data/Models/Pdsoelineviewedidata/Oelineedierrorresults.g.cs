...
namespace Infor.Sxe.OE.Data.Models.Pdsoelineviewedidata
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsoelineviewedidata.Oelineedierrorresults")]
   public partial class Oelineedierrorresults : ModelBase
   {
      ...
      public static Oelineedierrorresults BuildOelineedierrorresultsFromRow(DataRow row)
      {
         Oelineedierrorresults entity = new Oelineedierrorresults();
      ...
      /// </summary>
      public static void UpdateRowFromOelineedierrorresults(ref DataRow row, Oelineedierrorresults entity)
      {
