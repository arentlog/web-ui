...
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsloadoeelktt.Loadoeelkttcriteria")]
   public partial class Loadoeelkttcriteria : ModelBase
   {
      ...
      public static Loadoeelkttcriteria BuildLoadoeelkttcriteriaFromRow(DataRow row)
      {
         Loadoeelkttcriteria entity = new Loadoeelkttcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromLoadoeelkttcriteria(ref DataRow row, Loadoeelkttcriteria entity)
      {
