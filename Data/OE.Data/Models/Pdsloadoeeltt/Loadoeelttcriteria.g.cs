...
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsloadoeeltt.Loadoeelttcriteria")]
   public partial class Loadoeelttcriteria : ModelBase
   {
      ...
      public static Loadoeelttcriteria BuildLoadoeelttcriteriaFromRow(DataRow row)
      {
         Loadoeelttcriteria entity = new Loadoeelttcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromLoadoeelttcriteria(ref DataRow row, Loadoeelttcriteria entity)
      {
