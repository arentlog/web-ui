...
namespace Infor.Sxe.OE.Data.Models.Pdskitscriteria
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdskitscriteria.Kitscriteria")]
   public partial class Kitscriteria : ModelBase
   {
      ...
      public bool treqonlychecked { get; set; }
      [StringValidationAttribute]
      public string userfield { get; set; }


      public static Kitscriteria BuildKitscriteriaFromRow(DataRow row)
      {
         Kitscriteria entity = new Kitscriteria();
         ...
         entity.state = row.IsNull("state") ? 0 : row.Field<int>("state");
         entity.fabwhse = row.IsNull("fabwhse") ? string.Empty : row.Field<string>("fabwhse");
         entity.treqonlychecked = row.Field<bool>("treqonlychecked");
      ...
      /// </summary>
      public static void UpdateRowFromKitscriteria(ref DataRow row, Kitscriteria entity)
      {
         ...
         row.SetField("treqonlychecked", entity.treqonlychecked);
