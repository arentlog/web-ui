...
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsloadoeelalltt.Loadoeelallttresults")]
   public partial class Loadoeelallttresults : ModelBase, IUserFields
   {
      ...
      public static Loadoeelallttresults BuildLoadoeelallttresultsFromRow(DataRow row)
      {
         Loadoeelallttresults entity = new Loadoeelallttresults();
      ...
      /// </summary>
      public static void UpdateRowFromLoadoeelallttresults(ref DataRow row, Loadoeelallttresults entity)
      {
