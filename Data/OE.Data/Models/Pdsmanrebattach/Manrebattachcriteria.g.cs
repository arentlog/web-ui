...
namespace Infor.Sxe.OE.Data.Models.Pdsmanrebattach
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsmanrebattach.Manrebattachcriteria")]
   public partial class Manrebattachcriteria : ModelBase
   {
      ...
      public static Manrebattachcriteria BuildManrebattachcriteriaFromRow(DataRow row)
      {
         Manrebattachcriteria entity = new Manrebattachcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromManrebattachcriteria(ref DataRow row, Manrebattachcriteria entity)
      {
