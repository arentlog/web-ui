...
namespace Infor.Sxe.OE.Data.Models.Pdsoeetassemblybuild
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsoeetassemblybuild.Oeetassemblybuildcriteria")]
   public partial class Oeetassemblybuildcriteria : ModelBase
   {
      ...
      public static Oeetassemblybuildcriteria BuildOeetassemblybuildcriteriaFromRow(DataRow row)
      {
         Oeetassemblybuildcriteria entity = new Oeetassemblybuildcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromOeetassemblybuildcriteria(ref DataRow row, Oeetassemblybuildcriteria entity)
      {
