...
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsoebundles.Oebundlesresults")]
   public partial class Oebundlesresults : ModelBase
   {
      ...
      public static Oebundlesresults BuildOebundlesresultsFromRow(DataRow row)
      {
         Oebundlesresults entity = new Oebundlesresults();
      ...
      /// </summary>
      public static void UpdateRowFromOebundlesresults(ref DataRow row, Oebundlesresults entity)
      {
