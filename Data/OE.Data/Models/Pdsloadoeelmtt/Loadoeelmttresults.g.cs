...
namespace Infor.Sxe.OE.Data.Models.Pdsloadoeelmtt
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsloadoeelmtt.Loadoeelmttresults")]
   public partial class Loadoeelmttresults : ModelBase, IUserFields
   {
      ...
      public static Loadoeelmttresults BuildLoadoeelmttresultsFromRow(DataRow row)
      {
         Loadoeelmttresults entity = new Loadoeelmttresults();
      ...
      /// </summary>
      public static void UpdateRowFromLoadoeelmttresults(ref DataRow row, Loadoeelmttresults entity)
      {
