...
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsloadoeelmtt.Loadoeelmttcriteria")]
   public partial class Loadoeelmttcriteria : ModelBase
   {
      ...
      public static Loadoeelmttcriteria BuildLoadoeelmttcriteriaFromRow(DataRow row)
      {
         Loadoeelmttcriteria entity = new Loadoeelmttcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromLoadoeelmttcriteria(ref DataRow row, Loadoeelmttcriteria entity)
      {
