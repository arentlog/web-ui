...
{
   [ModelName("Infor.Sxe.OE.Data.Models.Pdsoeblanketupdbyrelease.Oeblanketupdbyrelupdresults")]
   public partial class Oeblanketupdbyrelupdresults : ModelBase
   {
      ...
      public static Oeblanketupdbyrelupdresults BuildOeblanketupdbyrelupdresultsFromRow(DataRow row)
      {
         Oeblanketupdbyrelupdresults entity = new Oeblanketupdbyrelupdresults();
      ...
      /// </summary>
      public static void UpdateRowFromOeblanketupdbyrelupdresults(ref DataRow row, Oeblanketupdbyrelupdresults entity)
      {
