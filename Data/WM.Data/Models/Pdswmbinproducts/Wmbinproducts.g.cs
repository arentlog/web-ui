...
namespace Infor.Sxe.WM.Data.Models.Pdswmbinproducts
{
   [ModelName("Infor.Sxe.WM.Data.Models.Pdswmbinproducts.Wmbinproducts")]
   public partial class Wmbinproducts : ModelBase
   {
      ...
      public static Wmbinproducts BuildWmbinproductsFromRow(DataRow row)
      {
         Wmbinproducts entity = new Wmbinproducts();
      ...
      /// </summary>
      public static void UpdateRowFromWmbinproducts(ref DataRow row, Wmbinproducts entity)
      {
