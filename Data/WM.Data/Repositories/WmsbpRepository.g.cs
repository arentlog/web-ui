...
namespace Infor.Sxe.WM.Data.Repositories
{
   ...
   public partial class WmsbpRepository : RepositoryBase
   {
      private WmsbpAdapter adapter;
  
      public WmsbpRepository(IProgressConnection connection)
      {
         this.adapter = new WmsbpAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, whse, binloc, prod, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByWmfifo(cono, whse, prod, lstoredt, binloc, batchsize, fldList);
      }
