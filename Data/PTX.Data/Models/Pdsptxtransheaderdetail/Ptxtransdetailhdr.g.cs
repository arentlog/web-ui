...
{
   [ModelName("Infor.Sxe.PTX.Data.Models.Pdsptxtransheaderdetail.Ptxtransdetailhdr")]
   public partial class Ptxtransdetailhdr : ModelBase, IUserFields
   {
      ...
      public static Ptxtransdetailhdr BuildPtxtransdetailhdrFromRow(DataRow row)
      {
         Ptxtransdetailhdr entity = new Ptxtransdetailhdr();
      ...
      /// </summary>
      public static void UpdateRowFromPtxtransdetailhdr(ref DataRow row, Ptxtransdetailhdr entity)
      {
