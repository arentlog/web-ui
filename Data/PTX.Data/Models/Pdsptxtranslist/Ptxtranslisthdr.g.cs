...
{
   [ModelName("Infor.Sxe.PTX.Data.Models.Pdsptxtranslist.Ptxtranslisthdr")]
   public partial class Ptxtranslisthdr : ModelBase, IUserFields
   {
      ...
      public static Ptxtranslisthdr BuildPtxtranslisthdrFromRow(DataRow row)
      {
         Ptxtranslisthdr entity = new Ptxtranslisthdr();
      ...
      /// </summary>
      public static void UpdateRowFromPtxtranslisthdr(ref DataRow row, Ptxtranslisthdr entity)
      {
