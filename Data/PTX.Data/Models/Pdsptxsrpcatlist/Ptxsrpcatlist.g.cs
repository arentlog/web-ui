...
{
   [ModelName("Infor.Sxe.PTX.Data.Models.Pdsptxsrpcatlist.Ptxsrpcatlist")]
   public partial class Ptxsrpcatlist : ModelBase
   {
      ...
      public static Ptxsrpcatlist BuildPtxsrpcatlistFromRow(DataRow row)
      {
         Ptxsrpcatlist entity = new Ptxsrpcatlist();
      ...
      /// </summary>
      public static void UpdateRowFromPtxsrpcatlist(ref DataRow row, Ptxsrpcatlist entity)
      {
