...
namespace Infor.Sxe.Shared.Data.Models.Pdswebmodlistresults
{
   [ModelName("Infor.Sxe.Shared.Data.Models.Pdswebmodlistresults.Webmodlistresults")]
   public partial class Webmodlistresults : ModelBase, IUserFields
   {
      ...
      public static Webmodlistresults BuildWebmodlistresultsFromRow(DataRow row)
      {
         Webmodlistresults entity = new Webmodlistresults();
      ...
      /// </summary>
      public static void UpdateRowFromWebmodlistresults(ref DataRow row, Webmodlistresults entity)
      {
