...
namespace Infor.Sxe.Shared.Data.Repositories
{
   ...
   public partial class ReplicteRepository : RepositoryBase
   {
      private ReplicteAdapter adapter;
  
      public ReplicteRepository(IProgressConnection connection)
      {
         this.adapter = new ReplicteAdapter(connection);
