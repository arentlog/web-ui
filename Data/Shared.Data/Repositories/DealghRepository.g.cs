...
namespace Infor.Sxe.Shared.Data.Repositories
{
   ...
   public partial class DealghRepository : RepositoryBase
   {
      private DealghAdapter adapter;
  
      public DealghRepository(IProgressConnection connection)
      {
         this.adapter = new DealghAdapter(connection);
      ...
      {
         return this.adapter.GetListByGrouptype(cono, grouptype, groupnm, batchsize, fldList);
      }
