...
namespace Infor.Sxe.Shared.Data.Repositories
{
   ...
   public partial class DealgdRepository : RepositoryBase
   {
      private DealgdAdapter adapter;
  
      public DealgdRepository(IProgressConnection connection)
      {
         this.adapter = new DealgdAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, groupnm, gdtype, gdentity, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByEntity(cono, gdtype, gdentity, batchsize, fldList);
      }
