...
namespace Infor.Sxe.Shared.Data.Repositories
{
   ...
   public partial class AodataRepository : RepositoryBase
   {
      private AodataAdapter adapter;
  
      public AodataRepository(IProgressConnection connection)
      {
         this.adapter = new AodataAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, recordtype, fieldname, batchsize, fldList);
      }
