...
namespace Infor.Sxe.Shared.Data.Repositories
{
   ...
   public partial class ComRepository : RepositoryBase
   {
      private ComAdapter adapter;
  
      public ComRepository(IProgressConnection connection)
      {
         this.adapter = new ComAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, comtype, orderno, ordersuf, lineno, printfl, batchsize, fldList);
      }
