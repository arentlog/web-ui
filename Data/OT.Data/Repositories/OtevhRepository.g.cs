...
namespace Infor.Sxe.OT.Data.Repositories
{
   ...
   public partial class OtevhRepository : RepositoryBase
   {
      private OtevhAdapter adapter;
  
      public OtevhRepository(IProgressConnection connection)
      {
         this.adapter = new OtevhAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, vesselno, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByStagecd(cono, stagecd, vesselno, batchsize, fldList);
      }
      ...
      {
         return this.adapter.Lookup(otvessellookupcriteria);
      }
