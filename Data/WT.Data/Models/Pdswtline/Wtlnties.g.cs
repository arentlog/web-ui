...
{
   [ModelName("Infor.Sxe.WT.Data.Models.Pdswtline.Wtlnties")]
   public partial class Wtlnties : ModelBase
   {
      ...
      public static Wtlnties BuildWtlntiesFromRow(DataRow row)
      {
         Wtlnties entity = new Wtlnties();
      ...
      /// </summary>
      public static void UpdateRowFromWtlnties(ref DataRow row, Wtlnties entity)
      {
