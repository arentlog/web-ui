...
{
   [ModelName("Infor.Sxe.WT.Data.Models.Pdswtitbuildwtlist.Wtitbuildwtlistresults")]
   public partial class Wtitbuildwtlistresults : ModelBase
   {
      ...
      public static Wtitbuildwtlistresults BuildWtitbuildwtlistresultsFromRow(DataRow row)
      {
         Wtitbuildwtlistresults entity = new Wtitbuildwtlistresults();
      ...
      /// </summary>
      public static void UpdateRowFromWtitbuildwtlistresults(ref DataRow row, Wtitbuildwtlistresults entity)
      {
