...
{
   [ModelName("Infor.Sxe.WT.Data.Models.Pdswtitbuildwttracklist.Wtitbuildwttracklistcriteria")]
   public partial class Wtitbuildwttracklistcriteria : ModelBase
   {
      ...
      public static Wtitbuildwttracklistcriteria BuildWtitbuildwttracklistcriteriaFromRow(DataRow row)
      {
         Wtitbuildwttracklistcriteria entity = new Wtitbuildwttracklistcriteria();
      ...
      /// </summary>
      public static void UpdateRowFromWtitbuildwttracklistcriteria(ref DataRow row, Wtitbuildwttracklistcriteria entity)
      {
