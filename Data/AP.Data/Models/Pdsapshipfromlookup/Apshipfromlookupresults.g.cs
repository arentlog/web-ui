...
{
   [ModelName("Infor.Sxe.AP.Data.Models.Pdsapshipfromlookup.Apshipfromlookupresults")]
   public partial class Apshipfromlookupresults : ModelBase, IUserFields
   {
      ...
      [StringValidationAttribute]
      public string rowidApss { get; set; }
      public string CompleteAddress { get { return this.addr1 + "," + this.city + "," + this.state + "," + this.zipcd; } }


      public static Apshipfromlookupresults BuildApshipfromlookupresultsFromRow(DataRow row)
      {
         Apshipfromlookupresults entity = new Apshipfromlookupresults();
         ...
         entity.rowidApss = row.Field<byte[]>("rowid-apss").ToStringEncoded();
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromApshipfromlookupresults(ref DataRow row, Apshipfromlookupresults entity)
      {
         ...
         row.SetField("rowid-apss", entity.rowidApss.ToByteArray());
