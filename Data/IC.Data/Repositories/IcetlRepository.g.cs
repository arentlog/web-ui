...
namespace Infor.Sxe.IC.Data.Repositories
{
   ...
   public partial class IcetlRepository : RepositoryBase
   {
      private IcetlAdapter adapter;
  
      public IcetlRepository(IProgressConnection connection)
      {
         this.adapter = new IcetlAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, prod, whse, lotno, ordertype, orderno, ordersuf, lineno, seqno, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByPostdt(cono, whse, prod, lotno, postdt, batchsize, fldList);
      }
