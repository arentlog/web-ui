...
namespace Infor.Sxe.IC.Data.Repositories
{
   ...
   public partial class IcsewRepository : RepositoryBase
   {
      private IcsewAdapter adapter;
  
      public IcsewRepository(IProgressConnection connection)
      {
         this.adapter = new IcsewAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, whse, whse2, batchsize, fldList);
      }
