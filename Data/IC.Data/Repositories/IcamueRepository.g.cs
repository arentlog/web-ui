...
namespace Infor.Sxe.IC.Data.Repositories
{
   ...
   public partial class IcamueRepository : RepositoryBase
   {
      private IcamueAdapter adapter;
  
      public IcamueRepository(IProgressConnection connection)
      {
         this.adapter = new IcamueAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, activefl, whse, buyer, prod, frozentype, frozenmmyy, exctype, batchsize, fldList);
      }
