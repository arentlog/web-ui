...
namespace Infor.Sxe.IC.Data.Repositories
{
   ...
   public partial class IcsdRepository : RepositoryBase
   {
      private IcsdAdapter adapter;
  
      public IcsdRepository(IProgressConnection connection)
      {
         this.adapter = new IcsdAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, whse, batchsize, fldList);
      }
      ...
      {
         return this.adapter.Lookup(warehouselookupcriteria);
      }
  
      public IEnumerable<Icsd> GetListByWordIndex(string term, int batchsize, string fldList)
      {
