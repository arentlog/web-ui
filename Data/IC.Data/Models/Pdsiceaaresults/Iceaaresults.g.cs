...
namespace Infor.Sxe.IC.Data.Models.Pdsiceaaresults
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsiceaaresults.Iceaaresults")]
   public partial class Iceaaresults : ModelBase
   {
      ...
      public static Iceaaresults BuildIceaaresultsFromRow(DataRow row)
      {
         Iceaaresults entity = new Iceaaresults();
      ...
      /// </summary>
      public static void UpdateRowFromIceaaresults(ref DataRow row, Iceaaresults entity)
      {
