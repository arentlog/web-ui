...
namespace Infor.Sxe.IC.Data.Models.Pdsicsep
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicsep.Icsep")]
   public partial class Icsep : IcsepBase
   {
      ...
      /// </summary>   
      public static Icsep BuildIcsepFromRow(DataRow row)
      {
         var entity = BuildIcsepBaseFromRow<Icsep>(row);
      ...
      /// </summary>
      public static void BuildMinimalRow(ref DataRow row, Icsep entity)
      {
         IcsepBase.BuildMinimalRow(ref row, entity);
      }
      
      /// <summary>
      /// Update a database row from a class
      /// </summary>
      public static void UpdateRowFromIcsep(ref DataRow row, Icsep entity)
      {
         UpdateRowFromIcsepBase(ref row, entity);
      }
