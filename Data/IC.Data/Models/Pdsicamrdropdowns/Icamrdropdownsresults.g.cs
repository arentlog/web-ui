...
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicamrdropdowns.Icamrdropdownsresults")]
   public partial class Icamrdropdownsresults : ModelBase
   {
      ...
      public static Icamrdropdownsresults BuildIcamrdropdownsresultsFromRow(DataRow row)
      {
         Icamrdropdownsresults entity = new Icamrdropdownsresults();
      ...
      /// </summary>
      public static void UpdateRowFromIcamrdropdownsresults(ref DataRow row, Icamrdropdownsresults entity)
      {
