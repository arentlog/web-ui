...
namespace Infor.Sxe.IC.Data.Models.Pdsicspecprccostcreate
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicspecprccostcreate.Icspecprccostcreate")]
   public partial class Icspecprccostcreate : ModelBase, IUserFields
   {
      ...
      public static Icspecprccostcreate BuildIcspecprccostcreateFromRow(DataRow row)
      {
         Icspecprccostcreate entity = new Icspecprccostcreate();
      ...
      /// </summary>
      public static void UpdateRowFromIcspecprccostcreate(ref DataRow row, Icspecprccostcreate entity)
      {
