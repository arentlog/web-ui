...
namespace Infor.Sxe.IC.Data.Models.Pdsicimbundles
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicimbundles.Icimbundles")]
   public partial class Icimbundles : ModelBase
   {
      ...
      public static Icimbundles BuildIcimbundlesFromRow(DataRow row)
      {
         Icimbundles entity = new Icimbundles();
         ...
         entity.ordernum = row.IsNull("ordernum") ? string.Empty : row.Field<string>("ordernum");
      ...
      /// </summary>
      public static void UpdateRowFromIcimbundles(ref DataRow row, Icimbundles entity)
      {
         ...
         row.SetField("ordernum", entity.ordernum);
