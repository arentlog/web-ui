...
namespace Infor.Sxe.IC.Data.Models.Pdsicsebloose
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicsebloose.Icsebloose")]
   public partial class Icsebloose : ModelBase, IUserFields
   {
      ...
      public static Icsebloose BuildIcseblooseFromRow(DataRow row)
      {
         Icsebloose entity = new Icsebloose();
      ...
      /// </summary>
      public static void UpdateRowFromIcsebloose(ref DataRow row, Icsebloose entity)
      {
