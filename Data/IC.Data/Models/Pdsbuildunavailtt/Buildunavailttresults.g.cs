...
namespace Infor.Sxe.IC.Data.Models.Pdsbuildunavailtt
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsbuildunavailtt.Buildunavailttresults")]
   public partial class Buildunavailttresults : ModelBase, IUserFields
   {
      ...
      public static Buildunavailttresults BuildBuildunavailttresultsFromRow(DataRow row)
      {
         Buildunavailttresults entity = new Buildunavailttresults();
      ...
      /// </summary>
      public static void UpdateRowFromBuildunavailttresults(ref DataRow row, Buildunavailttresults entity)
      {
