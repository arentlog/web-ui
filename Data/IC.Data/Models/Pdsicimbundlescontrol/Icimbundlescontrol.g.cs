...
namespace Infor.Sxe.IC.Data.Models.Pdsicimbundlescontrol
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicimbundlescontrol.Icimbundlescontrol")]
   public partial class Icimbundlescontrol : ModelBase
   {
      ...
      public static Icimbundlescontrol BuildIcimbundlescontrolFromRow(DataRow row)
      {
         Icimbundlescontrol entity = new Icimbundlescontrol();
      ...
      /// </summary>
      public static void UpdateRowFromIcimbundlescontrol(ref DataRow row, Icimbundlescontrol entity)
      {
