...
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsloadusagehistory.Loadusagecriteria")]
   public partial class Loadusagecriteria : ModelBase
   {
      ...
      public static Loadusagecriteria BuildLoadusagecriteriaFromRow(DataRow row)
      {
         Loadusagecriteria entity = new Loadusagecriteria();
      ...
      /// </summary>
      public static void UpdateRowFromLoadusagecriteria(ref DataRow row, Loadusagecriteria entity)
      {
