...
namespace Infor.Sxe.IC.Data.Models.Pdsicearbuildlistresults
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicearbuildlistresults.Icearbuildlistresults")]
   public partial class Icearbuildlistresults : ModelBase
   {
      ...
      public static Icearbuildlistresults BuildIcearbuildlistresultsFromRow(DataRow row)
      {
         Icearbuildlistresults entity = new Icearbuildlistresults();
      ...
      /// </summary>
      public static void UpdateRowFromIcearbuildlistresults(ref DataRow row, Icearbuildlistresults entity)
      {
