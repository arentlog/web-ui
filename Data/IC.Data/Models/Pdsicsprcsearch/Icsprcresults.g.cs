...
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicsprcsearch.Icsprcresults")]
   public partial class Icsprcresults : ModelBase, IUserFields
   {
      ...
      public static Icsprcresults BuildIcsprcresultsFromRow(DataRow row)
      {
         Icsprcresults entity = new Icsprcresults();
      ...
      /// </summary>
      public static void UpdateRowFromIcsprcresults(ref DataRow row, Icsprcresults entity)
      {
