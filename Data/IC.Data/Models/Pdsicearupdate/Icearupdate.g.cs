...
namespace Infor.Sxe.IC.Data.Models.Pdsicearupdate
{
   [ModelName("Infor.Sxe.IC.Data.Models.Pdsicearupdate.Icearupdate")]
   public partial class Icearupdate : ModelBase
   {
      ...
      public static Icearupdate BuildIcearupdateFromRow(DataRow row)
      {
         Icearupdate entity = new Icearupdate();
      ...
      /// </summary>
      public static void UpdateRowFromIcearupdate(ref DataRow row, Icearupdate entity)
      {
