...
namespace Infor.Sxe.BP.Data.Repositories
{
   ...
   public partial class BpspRepository : RepositoryBase
   {
      private BpspAdapter adapter;
  
      public BpspRepository(IProgressConnection connection)
      {
         this.adapter = new BpspAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, phaseid, batchsize, fldList);
      }
