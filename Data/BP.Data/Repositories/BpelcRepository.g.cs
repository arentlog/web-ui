...
namespace Infor.Sxe.BP.Data.Repositories
{
   ...
   public partial class BpelcRepository : RepositoryBase
   {
      private BpelcAdapter adapter;
  
      public BpelcRepository(IProgressConnection connection)
      {
         this.adapter = new BpelcAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, bpid, revno, lineno, convertty, convertno, ordersuf, oelineno, seqno, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByBpelcoe(cono, convertty, convertno, oelineno, batchsize, fldList);
      }
