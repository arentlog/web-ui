...
namespace Infor.Sxe.TWL.Data.Models.Pdsinvtrans
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsinvtrans.Invtrans")]
   public partial class Invtrans : ModelBase
   {
      ...
      public static Invtrans BuildInvtransFromRow(DataRow row)
      {
         Invtrans entity = new Invtrans();
      ...
      /// </summary>
      public static void UpdateRowFromInvtrans(ref DataRow row, Invtrans entity)
      {
