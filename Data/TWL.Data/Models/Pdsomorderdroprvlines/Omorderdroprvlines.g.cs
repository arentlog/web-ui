...
namespace Infor.Sxe.TWL.Data.Models.Pdsomorderdroprvlines
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsomorderdroprvlines.Omorderdroprvlines")]
   public partial class Omorderdroprvlines : ModelBase
   {
      ...
      public bool isAssignedPicks { get; set; }
      [StringValidationAttribute]
      ...
      public static Omorderdroprvlines BuildOmorderdroprvlinesFromRow(DataRow row)
      {
         Omorderdroprvlines entity = new Omorderdroprvlines();
         ...
         entity.isAssignedPicks = row.Field<bool>("is_assigned_picks");
      ...
      /// </summary>
      public static void UpdateRowFromOmorderdroprvlines(ref DataRow row, Omorderdroprvlines entity)
      {
         ...
         row.SetField("is_assigned_picks", entity.isAssignedPicks);
