...
namespace Infor.Sxe.TWL.Data.Models.Pdsbldmultiloclistcriteria
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsbldmultiloclistcriteria.Bldmultiloclistcriteria")]
   public partial class Bldmultiloclistcriteria : ModelBase
   {
      ...
      public bool isOnlyShowFormat { get; set; }


      public static Bldmultiloclistcriteria BuildBldmultiloclistcriteriaFromRow(DataRow row)
      {
         Bldmultiloclistcriteria entity = new Bldmultiloclistcriteria();
         ...
         entity.isOnlyShowFormat = row.Field<bool>("isOnlyShowFormat");
         return entity;
      }
      ...
      /// </summary>
      public static void UpdateRowFromBldmultiloclistcriteria(ref DataRow row, Bldmultiloclistcriteria entity)
      {
         ...
         row.SetField("isOnlyShowFormat", entity.isOnlyShowFormat);
