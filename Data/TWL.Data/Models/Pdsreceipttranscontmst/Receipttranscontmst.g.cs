...
namespace Infor.Sxe.TWL.Data.Models.Pdsreceipttranscontmst
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsreceipttranscontmst.Receipttranscontmst")]
   public partial class Receipttranscontmst : ModelBase
   {
      ...
      public bool asnExistFl { get; set; }
      public bool commentsExistFl { get; set; }
      [StringValidationAttribute]
      public string userfield { get; set; }


      public static Receipttranscontmst BuildReceipttranscontmstFromRow(DataRow row)
      {
         Receipttranscontmst entity = new Receipttranscontmst();
         ...
         entity.asnExistFl = row.Field<bool>("asnExistFl");
      ...
      /// </summary>
      public static void UpdateRowFromReceipttranscontmst(ref DataRow row, Receipttranscontmst entity)
      {
         ...
         row.SetField("asnExistFl", entity.asnExistFl);
