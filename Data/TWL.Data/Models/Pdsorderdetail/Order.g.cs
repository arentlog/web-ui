...
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsorderdetail.Order")]
   public partial class Order : ModelBase
   {
      ...
      [StringValidationAttribute]
      public string custNameArsc { get; set; }
      [StringValidationAttribute]
      ...
      [StringValidationAttribute]
      public string custmastDelRoute { get; set; }
      [StringValidationAttribute]
      public string dockmasterDockId { get; set; }
      [StringValidationAttribute]
      public string dockmasterStage { get; set; }
      public decimal numCartons { get; set; }
      public decimal totUnits { get; set; }
      [StringValidationAttribute]
      ...
      public static Order BuildOrderFromRow(DataRow row)
      {
         ...
         entity.custNameArsc = row.IsNull("cust_name_arsc") ? string.Empty : row.Field<string>("cust_name_arsc");
         ...
         entity.custmastDelRoute = row.IsNull("custmast_del_route") ? string.Empty : row.Field<string>("custmast_del_route");
         entity.dockmasterDockId = row.IsNull("dockmaster_dock_id") ? string.Empty : row.Field<string>("dockmaster_dock_id");
         entity.dockmasterStage = row.IsNull("dockmaster_stage") ? string.Empty : row.Field<string>("dockmaster_stage");
         entity.numCartons = row.IsNull("num_cartons") ? decimal.Zero : row.Field<decimal>("num_cartons");
         entity.totUnits = row.IsNull("tot_units") ? decimal.Zero : row.Field<decimal>("tot_units");
      ...
      /// </summary>
      public static void UpdateRowFromOrder(ref DataRow row, Order entity)
      {
         ...
         row.SetField("cust_name_arsc", entity.custNameArsc);
         ...
         row.SetField("custmast_del_route", entity.custmastDelRoute);
         row.SetField("dockmaster_dock_id", entity.dockmasterDockId);
         row.SetField("dockmaster_stage", entity.dockmasterStage);
         row.SetField("num_cartons", entity.numCartons);
         row.SetField("tot_units", entity.totUnits);
