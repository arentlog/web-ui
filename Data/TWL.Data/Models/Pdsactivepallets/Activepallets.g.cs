...
namespace Infor.Sxe.TWL.Data.Models.Pdsactivepallets
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsactivepallets.Activepallets")]
   public partial class Activepallets : ModelBase
   {
      ...
      public static Activepallets BuildActivepalletsFromRow(DataRow row)
      {
         Activepallets entity = new Activepallets();
      ...
      /// </summary>
      public static void UpdateRowFromActivepallets(ref DataRow row, Activepallets entity)
      {
