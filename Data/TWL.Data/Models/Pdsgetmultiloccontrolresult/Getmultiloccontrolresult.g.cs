...
namespace Infor.Sxe.TWL.Data.Models.Pdsgetmultiloccontrolresult
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsgetmultiloccontrolresult.Getmultiloccontrolresult")]
   public partial class Getmultiloccontrolresult : ModelBase
   {
      ...
      [StringValidationAttribute]
      public string binLocationMask { get; set; }
      public decimal expRecordCount { get; set; }
      [StringValidationAttribute]
      public string userfield { get; set; }


      public static Getmultiloccontrolresult BuildGetmultiloccontrolresultFromRow(DataRow row)
      {
         Getmultiloccontrolresult entity = new Getmultiloccontrolresult();
         ...
         entity.startTime = row.IsNull("startTime") ? string.Empty : row.Field<string>("startTime");
         entity.endDate = row.Field<DateTime?>("endDate");
         entity.endTime = row.IsNull("endTime") ? string.Empty : row.Field<string>("endTime");
         entity.statusCode = row.IsNull("statusCode") ? 0 : row.Field<int>("statusCode");
         entity.recordCount = row.IsNull("recordCount") ? 0 : row.Field<int>("recordCount");
         entity.binLocationMask = row.IsNull("binLocationMask") ? string.Empty : row.Field<string>("binLocationMask");
         entity.expRecordCount = row.IsNull("expRecordCount") ? decimal.Zero : row.Field<decimal>("expRecordCount");
      ...
      /// </summary>
      public static void UpdateRowFromGetmultiloccontrolresult(ref DataRow row, Getmultiloccontrolresult entity)
      {
         ...
         row.SetField("startTime", entity.startTime);
         row.SetField("endDate", entity.endDate);
         row.SetField("endTime", entity.endTime);
         row.SetField("statusCode", entity.statusCode);
         row.SetField("recordCount", entity.recordCount);
         row.SetField("binLocationMask", entity.binLocationMask);
         row.SetField("expRecordCount", entity.expRecordCount);
