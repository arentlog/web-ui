...
namespace Infor.Sxe.TWL.Data.Models.Pdsphysinvdiscinvresults
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsphysinvdiscinvresults.Physinvdiscinvresults")]
   public partial class Physinvdiscinvresults : ModelBase
   {
      ...
      [StringValidationAttribute]
      public string invdiscinvresultsuserfield { get; set; }
      [StringValidationAttribute]
      public string userfield { get; set; }


      public static Physinvdiscinvresults BuildPhysinvdiscinvresultsFromRow(DataRow row)
      {
         Physinvdiscinvresults entity = new Physinvdiscinvresults();
         ...
         entity.invdiscinvresultsuserfield = row.IsNull("invdiscinvresultsuserfield") ? string.Empty : row.Field<string>("invdiscinvresultsuserfield");
      ...
      /// </summary>
      public static void UpdateRowFromPhysinvdiscinvresults(ref DataRow row, Physinvdiscinvresults entity)
      {
         ...
         row.SetField("invdiscinvresultsuserfield", entity.invdiscinvresultsuserfield);
