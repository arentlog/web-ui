...
namespace Infor.Sxe.TWL.Data.Models.Pdsomorderlinekey
{
   [ModelName("Infor.Sxe.TWL.Data.Models.Pdsomorderlinekey.Omorderlinekey")]
   public partial class Omorderlinekey : ModelBase
   {
      ...
      public static Omorderlinekey BuildOmorderlinekeyFromRow(DataRow row)
      {
         Omorderlinekey entity = new Omorderlinekey();
      ...
      /// </summary>
      public static void UpdateRowFromOmorderlinekey(ref DataRow row, Omorderlinekey entity)
      {
