...
namespace Infor.Sxe.TWL.Data.Repositories
{
   ...
   public partial class OrddtlRepository : RepositoryBase
   {
      private OrddtlAdapter adapter;
  
      public OrddtlRepository(IProgressConnection connection)
      {
         this.adapter = new OrddtlAdapter(connection);
      ...
      {
         return this.adapter.Get(id, line, lineSequence, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByCoWhAssignedAbs(coNum, whNum, assigned, absNum, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByCoWhLineStatus(coNum, whNum, lineStatus, batchsize, fldList);
      }

      public IEnumerable<Orddtl> GetListByIdAbs(int id, string absNum, int batchsize, string fldList)
      {
         return this.adapter.GetListByIdAbs(id, absNum, batchsize, fldList);
      }
