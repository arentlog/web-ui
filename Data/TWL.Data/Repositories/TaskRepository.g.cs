...
namespace Infor.Sxe.TWL.Data.Repositories
{
   ...
   public partial class TaskRepository : RepositoryBase
   {
      private TaskAdapter adapter;
  
      public TaskRepository(IProgressConnection connection)
      {
         this.adapter = new TaskAdapter(connection);
      ...
      {
         return this.adapter.Get(coNum, whNum, transType, requested, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByCoWhId(coNum, whNum, taskId, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByCoWhStatusType(coNum, whNum, taskStatus, transType, requested, batchsize, fldList);
      }

      public IEnumerable<Task> GetListById(int taskId, int batchsize, string fldList)
      {
         return this.adapter.GetListById(taskId, batchsize, fldList);
      }
