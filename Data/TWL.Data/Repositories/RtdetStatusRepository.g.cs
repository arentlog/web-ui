...
namespace Infor.Sxe.TWL.Data.Repositories
{
   ...
   public partial class RtdetStatusRepository : RepositoryBase
   {
      private RtdetStatusAdapter adapter;
  
      public RtdetStatusRepository(IProgressConnection connection)
      {
         this.adapter = new RtdetStatusAdapter(connection);
