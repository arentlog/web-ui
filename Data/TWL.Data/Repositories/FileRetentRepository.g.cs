...
namespace Infor.Sxe.TWL.Data.Repositories
{
   ...
   public partial class FileRetentRepository : RepositoryBase
   {
      private FileRetentAdapter adapter;
  
      public FileRetentRepository(IProgressConnection connection)
      {
         this.adapter = new FileRetentAdapter(connection);
      ...
      {
         return this.adapter.Get(fileName, batchsize, fldList);
      }
