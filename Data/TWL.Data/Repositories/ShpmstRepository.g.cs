...
namespace Infor.Sxe.TWL.Data.Repositories
{
   ...
   public partial class ShpmstRepository : RepositoryBase
   {
      private ShpmstAdapter adapter;
  
      public ShpmstRepository(IProgressConnection connection)
      {
         this.adapter = new ShpmstAdapter(connection);
      ...
      {
         return this.adapter.Get(coNum, whNum, carrierId, manifestId, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByCoWhDockTrailerCarrier(coNum, whNum, dockId, trailerNum, carrierId, batchsize, fldList);
      }

      public IEnumerable<Shpmst> GetListByDockStatus(string dockId, bool rowStatus, int batchsize, string fldList)
      {
         return this.adapter.GetListByDockStatus(dockId, rowStatus, batchsize, fldList);
      }

      public IEnumerable<Shpmst> GetListById(int manifestId, int batchsize, string fldList)
      {
         return this.adapter.GetListById(manifestId, batchsize, fldList);
      }

      public IEnumerable<Shpmst> GetListByStatusChrono(bool rowStatus, string dateTime, int batchsize, string fldList)
      {
         return this.adapter.GetListByStatusChrono(rowStatus, dateTime, batchsize, fldList);
      }

      public IEnumerable<Shpmst> GetListByTrailerStatus(string trailerNum, bool rowStatus, int batchsize, string fldList)
      {
         return this.adapter.GetListByTrailerStatus(trailerNum, rowStatus, batchsize, fldList);
      }
