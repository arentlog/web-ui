...
namespace Infor.Sxe.TWL.Data.Repositories
{
   ...
   public partial class EndOfDayRepository : RepositoryBase
   {
      private EndOfDayAdapter adapter;
  
      public EndOfDayRepository(IProgressConnection connection)
      {
         this.adapter = new EndOfDayAdapter(connection);
      ...
      {
         return this.adapter.Get(coNum, whNum, dateTime, recType, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByDateType(dateTime, recType, batchsize, fldList);
      }
