...
namespace Infor.Sxe.TWL.Data.Repositories
{
   ...
   public partial class OrddtlStatusRepository : RepositoryBase
   {
      private OrddtlStatusAdapter adapter;
  
      public OrddtlStatusRepository(IProgressConnection connection)
      {
         this.adapter = new OrddtlStatusAdapter(connection);
