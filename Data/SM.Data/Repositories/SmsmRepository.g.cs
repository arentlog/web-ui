...
namespace Infor.Sxe.SM.Data.Repositories
{
   ...
   public partial class SmsmRepository : RepositoryBase
   {
      private SmsmAdapter adapter;
  
      public SmsmRepository(IProgressConnection connection)
      {
         this.adapter = new SmsmAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, commtype, slsrep, batchsize, fldList);
      }
