...
{
   [ModelName("Infor.Sxe.GL.Data.Models.Pdsglinquiryaccount.Glinquiryaccountresults")]
   public partial class Glinquiryaccountresults : ModelBase, IUserFields
   {
      ...
      public static Glinquiryaccountresults BuildGlinquiryaccountresultsFromRow(DataRow row)
      {
         Glinquiryaccountresults entity = new Glinquiryaccountresults();
      ...
      /// </summary>
      public static void UpdateRowFromGlinquiryaccountresults(ref DataRow row, Glinquiryaccountresults entity)
      {
