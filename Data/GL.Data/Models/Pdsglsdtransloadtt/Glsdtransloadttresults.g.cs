...
{
   [ModelName("Infor.Sxe.GL.Data.Models.Pdsglsdtransloadtt.Glsdtransloadttresults")]
   public partial class Glsdtransloadttresults : ModelBase
   {
      ...
      public static Glsdtransloadttresults BuildGlsdtransloadttresultsFromRow(DataRow row)
      {
         Glsdtransloadttresults entity = new Glsdtransloadttresults();
      ...
      /// </summary>
      public static void UpdateRowFromGlsdtransloadttresults(ref DataRow row, Glsdtransloadttresults entity)
      {
