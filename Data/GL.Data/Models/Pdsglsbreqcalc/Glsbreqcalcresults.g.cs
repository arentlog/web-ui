...
{
   [ModelName("Infor.Sxe.GL.Data.Models.Pdsglsbreqcalc.Glsbreqcalcresults")]
   public partial class Glsbreqcalcresults : ModelBase
   {
      ...
      public static Glsbreqcalcresults BuildGlsbreqcalcresultsFromRow(DataRow row)
      {
         Glsbreqcalcresults entity = new Glsbreqcalcresults();
         ...
         entity.displaytext = row.IsNull("displaytext") ? string.Empty : row.Field<string>("displaytext");
      ...
      /// </summary>
      public static void UpdateRowFromGlsbreqcalcresults(ref DataRow row, Glsbreqcalcresults entity)
      {
         ...
         row.SetField("displaytext", entity.displaytext);
