...
namespace Infor.Sxe.GL.Data.Models.Pdsglsbsavechanges
{
   [ModelName("Infor.Sxe.GL.Data.Models.Pdsglsbsavechanges.Glsbsavechanges")]
   public partial class Glsbsavechanges : ModelBase
   {
      ...
      public static Glsbsavechanges BuildGlsbsavechangesFromRow(DataRow row)
      {
         Glsbsavechanges entity = new Glsbsavechanges();
      ...
      /// </summary>
      public static void UpdateRowFromGlsbsavechanges(ref DataRow row, Glsbsavechanges entity)
      {
