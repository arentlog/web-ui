...
{
   [ModelName("Infor.Sxe.GL.Data.Models.Pdsglembsearchupdate.Glembresults")]
   public partial class Glembresults : ModelBase
   {
      ...
      public static Glembresults BuildGlembresultsFromRow(DataRow row)
      {
         Glembresults entity = new Glembresults();
      ...
      /// </summary>
      public static void UpdateRowFromGlembresults(ref DataRow row, Glembresults entity)
      {
