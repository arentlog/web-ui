...
{
   [ModelName("Infor.Sxe.GL.Data.Models.Pdsglifdetailbrowser.Glifdetailbrowsercriteria")]
   public partial class Glifdetailbrowsercriteria : ModelBase
   {
      ...
      public static Glifdetailbrowsercriteria BuildGlifdetailbrowsercriteriaFromRow(DataRow row)
      {
         Glifdetailbrowsercriteria entity = new Glifdetailbrowsercriteria();
      ...
      /// </summary>
      public static void UpdateRowFromGlifdetailbrowsercriteria(ref DataRow row, Glifdetailbrowsercriteria entity)
      {
