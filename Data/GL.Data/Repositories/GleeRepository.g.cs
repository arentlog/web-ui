...
namespace Infor.Sxe.GL.Data.Repositories
{
   ...
   public partial class GleeRepository : RepositoryBase
   {
      private GleeAdapter adapter;
  
      public GleeRepository(IProgressConnection connection)
      {
         this.adapter = new GleeAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, keyno, setno, transno, batchsize, fldList);
      }
