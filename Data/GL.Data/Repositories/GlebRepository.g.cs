...
namespace Infor.Sxe.GL.Data.Repositories
{
   ...
   public partial class GlebRepository : RepositoryBase
   {
      private GlebAdapter adapter;
  
      public GlebRepository(IProgressConnection connection)
      {
         this.adapter = new GlebAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, function, reportnm, yr, gldivno, gldeptno, glacctno, glsubno, asofdt, batchsize, fldList);
      }
      ...
      {
         return this.adapter.GetListByGlno(yr, gldivno, gldeptno, glacctno, glsubno, asofdt, batchsize, fldList);
      }
