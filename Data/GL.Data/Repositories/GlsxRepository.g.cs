...
namespace Infor.Sxe.GL.Data.Repositories
{
   ...
   public partial class GlsxRepository : RepositoryBase
   {
      private GlsxAdapter adapter;
  
      public GlsxRepository(IProgressConnection connection)
      {
         this.adapter = new GlsxAdapter(connection);
      ...
      {
         return this.adapter.Get(cono, currencyty, yr, acctgrp, batchsize, fldList);
      }
