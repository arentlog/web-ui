...
{
   [ModelName("Infor.Sxe.KP.Data.Models.Pdsloadtcomps.Loadtcompssubresults")]
   public partial class Loadtcompssubresults : ModelBase, IUserFields
   {
      ...
      public static Loadtcompssubresults BuildLoadtcompssubresultsFromRow(DataRow row)
      {
         Loadtcompssubresults entity = new Loadtcompssubresults();
      ...
      /// </summary>
      public static void UpdateRowFromLoadtcompssubresults(ref DataRow row, Loadtcompssubresults entity)
      {
