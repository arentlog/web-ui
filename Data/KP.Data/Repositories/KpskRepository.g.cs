...
namespace Infor.Sxe.KP.Data.Repositories
{
   ...
   public partial class KpskRepository : RepositoryBase
   {
      private KpskAdapter adapter;
  
      public KpskRepository(IProgressConnection connection)
      {
         this.adapter = new KpskAdapter(connection);
      ...
      {
         return this.adapter.GetListByComprod(cono, comptype, comprod, batchsize, fldList);
      }

      public IEnumerable<Kpsk> GetListByComptype(int cono, string prod, string comptype, int batchsize, string fldList)
      {
         return this.adapter.GetListByComptype(cono, prod, comptype, batchsize, fldList);
      }
      ...
      {
         return this.adapter.Lookup(kpcomponentslookupcriteria);
      }
