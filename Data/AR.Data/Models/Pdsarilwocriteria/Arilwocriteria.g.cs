...
namespace Infor.Sxe.AR.Data.Models.Pdsarilwocriteria
{
   [ModelName("Infor.Sxe.AR.Data.Models.Pdsarilwocriteria.Arilwocriteria")]
   public partial class Arilwocriteria : ModelBase
   {
      ...
      public static Arilwocriteria BuildArilwocriteriaFromRow(DataRow row)
      {
         Arilwocriteria entity = new Arilwocriteria();
      ...
      /// </summary>
      public static void UpdateRowFromArilwocriteria(ref DataRow row, Arilwocriteria entity)
      {
