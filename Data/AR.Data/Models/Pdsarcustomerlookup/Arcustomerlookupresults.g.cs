...
{
   [ModelName("Infor.Sxe.AR.Data.Models.Pdsarcustomerlookup.Arcustomerlookupresults")]
   public partial class Arcustomerlookupresults : ModelBase, IUserFields
   {
      ...
      public static Arcustomerlookupresults BuildArcustomerlookupresultsFromRow(DataRow row)
      {
         Arcustomerlookupresults entity = new Arcustomerlookupresults();
      ...
      /// </summary>
      public static void UpdateRowFromArcustomerlookupresults(ref DataRow row, Arcustomerlookupresults entity)
      {
