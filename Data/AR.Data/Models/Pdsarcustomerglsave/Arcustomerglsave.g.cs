...
namespace Infor.Sxe.AR.Data.Models.Pdsarcustomerglsave
{
   [ModelName("Infor.Sxe.AR.Data.Models.Pdsarcustomerglsave.Arcustomerglsave")]
   public partial class Arcustomerglsave : ModelBase, IUserFields
   {
      ...
      [StringValidationAttribute]
      public string incomeglacct { get; set; }
      [StringValidationAttribute]
      ...
      public static Arcustomerglsave BuildArcustomerglsaveFromRow(DataRow row)
      {
         Arcustomerglsave entity = new Arcustomerglsave();
      ...
      /// </summary>
      public static void UpdateRowFromArcustomerglsave(ref DataRow row, Arcustomerglsave entity)
      {
