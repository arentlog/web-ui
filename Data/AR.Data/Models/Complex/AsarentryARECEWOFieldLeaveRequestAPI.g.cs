...
using Models.Pdsareceworeport;
   ...
   public partial class AsarentryARECEWOFieldLeaveRequestAPI
   {
      ...
      [StringValidation]
      public string pvSeqno { get; set; }
      [StringValidation]
      public string pvField { get; set; }
      public bool pvNewfl { get; set; }
 
    
      public AsarentryARECEWOFieldLeaveRequestAPI()
      {
