...
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdsloadpotally.Loadpotallyresults")]
   public partial class Loadpotallyresults : ModelBase, IUserFields
   {
      ...
      public static Loadpotallyresults BuildLoadpotallyresultsFromRow(DataRow row)
      {
         Loadpotallyresults entity = new Loadpotallyresults();
      ...
      /// </summary>
      public static void UpdateRowFromLoadpotallyresults(ref DataRow row, Loadpotallyresults entity)
      {
