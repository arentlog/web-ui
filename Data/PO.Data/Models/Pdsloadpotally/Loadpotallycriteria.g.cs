...
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdsloadpotally.Loadpotallycriteria")]
   public partial class Loadpotallycriteria : ModelBase
   {
      ...
      public static Loadpotallycriteria BuildLoadpotallycriteriaFromRow(DataRow row)
      {
         Loadpotallycriteria entity = new Loadpotallycriteria();
      ...
      /// </summary>
      public static void UpdateRowFromLoadpotallycriteria(ref DataRow row, Loadpotallycriteria entity)
      {
