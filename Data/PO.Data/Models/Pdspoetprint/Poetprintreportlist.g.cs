...
namespace Infor.Sxe.PO.Data.Models.Pdspoetprint
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdspoetprint.Poetprintreportlist")]
   public partial class Poetprintreportlist : ModelBase
   {
      ...
      public static Poetprintreportlist BuildPoetprintreportlistFromRow(DataRow row)
      {
         Poetprintreportlist entity = new Poetprintreportlist();
         ...
         entity.poprintfl = row.Field<bool>("poprintfl");
      ...
      /// </summary>
      public static void UpdateRowFromPoetprintreportlist(ref DataRow row, Poetprintreportlist entity)
      {
         ...
         row.SetField("poprintfl", entity.poprintfl);
