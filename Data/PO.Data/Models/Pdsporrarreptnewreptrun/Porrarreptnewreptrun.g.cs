...
namespace Infor.Sxe.PO.Data.Models.Pdsporrarreptnewreptrun
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdsporrarreptnewreptrun.Porrarreptnewreptrun")]
   public partial class Porrarreptnewreptrun : ModelBase
   {
      ...
      public static Porrarreptnewreptrun BuildPorrarreptnewreptrunFromRow(DataRow row)
      {
         Porrarreptnewreptrun entity = new Porrarreptnewreptrun();
      ...
      /// </summary>
      public static void UpdateRowFromPorrarreptnewreptrun(ref DataRow row, Porrarreptnewreptrun entity)
      {
