...
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdspoblanketupdbyrelease.Poblanketupdbyrelresults")]
   public partial class Poblanketupdbyrelresults : ModelBase
   {
      ...
      public static Poblanketupdbyrelresults BuildPoblanketupdbyrelresultsFromRow(DataRow row)
      {
         Poblanketupdbyrelresults entity = new Poblanketupdbyrelresults();
      ...
      /// </summary>
      public static void UpdateRowFromPoblanketupdbyrelresults(ref DataRow row, Poblanketupdbyrelresults entity)
      {
