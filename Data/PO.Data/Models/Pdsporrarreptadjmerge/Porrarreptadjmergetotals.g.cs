...
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdsporrarreptadjmerge.Porrarreptadjmergetotals")]
   public partial class Porrarreptadjmergetotals : ModelBase
   {
      ...
      public static Porrarreptadjmergetotals BuildPorrarreptadjmergetotalsFromRow(DataRow row)
      {
         Porrarreptadjmergetotals entity = new Porrarreptadjmergetotals();
      ...
      /// </summary>
      public static void UpdateRowFromPorrarreptadjmergetotals(ref DataRow row, Porrarreptadjmergetotals entity)
      {
