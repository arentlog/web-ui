...
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdspobundles.Pobundlesresults")]
   public partial class Pobundlesresults : ModelBase
   {
      ...
      public static Pobundlesresults BuildPobundlesresultsFromRow(DataRow row)
      {
         Pobundlesresults entity = new Pobundlesresults();
      ...
      /// </summary>
      public static void UpdateRowFromPobundlesresults(ref DataRow row, Pobundlesresults entity)
      {
