...
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdsporrarlinedspl.Porrarlinedspllinesur")]
   public partial class Porrarlinedspllinesur : ModelBase
   {
      ...
      public static Porrarlinedspllinesur BuildPorrarlinedspllinesurFromRow(DataRow row)
      {
         Porrarlinedspllinesur entity = new Porrarlinedspllinesur();
      ...
      /// </summary>
      public static void UpdateRowFromPorrarlinedspllinesur(ref DataRow row, Porrarlinedspllinesur entity)
      {
