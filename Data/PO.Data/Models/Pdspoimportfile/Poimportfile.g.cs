...
namespace Infor.Sxe.PO.Data.Models.Pdspoimportfile
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdspoimportfile.Poimportfile")]
   public partial class Poimportfile : ModelBase
   {
      ...
      public static Poimportfile BuildPoimportfileFromRow(DataRow row)
      {
         Poimportfile entity = new Poimportfile();
      ...
      /// </summary>
      public static void UpdateRowFromPoimportfile(ref DataRow row, Poimportfile entity)
      {
