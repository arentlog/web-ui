...
namespace Infor.Sxe.PO.Data.Models.Pdspovendorcredit
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdspovendorcredit.Povendorcredit")]
   public partial class Povendorcredit : ModelBase
   {
      ...
      public static Povendorcredit BuildPovendorcreditFromRow(DataRow row)
      {
         Povendorcredit entity = new Povendorcredit();
         ...
         entity.userem = row.Field<bool>("userem");
      ...
      /// </summary>
      public static void UpdateRowFromPovendorcredit(ref DataRow row, Povendorcredit entity)
      {
         ...
         row.SetField("userem", entity.userem);
