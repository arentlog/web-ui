...
namespace Infor.Sxe.PO.Data.Models.Pdsporrarreptadjdaysupdt
{
   [ModelName("Infor.Sxe.PO.Data.Models.Pdsporrarreptadjdaysupdt.Porrarreptadjdaysupdt")]
   public partial class Porrarreptadjdaysupdt : ModelBase
   {
      ...
      public static Porrarreptadjdaysupdt BuildPorrarreptadjdaysupdtFromRow(DataRow row)
      {
         Porrarreptadjdaysupdt entity = new Porrarreptadjdaysupdt();
         entity.reportno = row.IsNull("reportno") ? 0 : row.Field<int>("reportno");
         entity.reviewdays = row.IsNull("reviewdays") ? 0 : row.Field<int>("reviewdays");
      ...
      /// </summary>
      public static void UpdateRowFromPorrarreptadjdaysupdt(ref DataRow row, Porrarreptadjdaysupdt entity)
      {
         row.SetField("reportno", entity.reportno);
         row.SetField("reviewdays", entity.reviewdays);
