...
:DOBUILD
%MSBPATH% Build.proj /t:PackageNoCopyBuild /p:Configuration=Release /flp:logfile=PackageNoCopyBuildLog.txt /p:VisualStudioVersion=15.0 /m || GOTO ERROR
call npm install -g grunt-cli 
pushd FrontEnd\Infor.Sxe.Web.FrontEnd
ren package.json.grunt package.json
call npm install
call grunt build
ren package.json package.json.grunt
popd
